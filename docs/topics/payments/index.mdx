...
* [French check payments](../merchants/checks/index.mdx) *(merchant offer only)*
...
Refer to the schemas for [credit transfers](./credit-transfers/sepa/index.mdx#transfer-statuses), direct debits, and cards for more information about statuses for that payment method.
...
The **user must consent** to this action by performing a [strong customer authentication (SCA)](https://docs.swan.io/api/users/consent#strong-customer-authentication).
