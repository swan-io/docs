...
1. For this example, the <Term id="rolling-reserve">rolling reserve</Term> is 15% over 15 business days (exact rolling reserve amounts can change based on your contract with Swan). Therefore, the `Reserved` balance is €30 for 15 days.
