...
Before accepting in-person payments with cards, you need a merchant profile.
...
This lets merchants accept card payments from customers using their smartphone terminal.
