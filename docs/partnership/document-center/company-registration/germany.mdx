...
The following table describes the legal forms typically found for companies in Germany.
...
The following table describes the legal forms relevant to self-employed individuals and freelancers.
