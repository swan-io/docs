...
Updating a membership requires consent from the account member, and you must use a [user access token](../../../developers/using-api/authentication/index.mdx#tokens-user).
