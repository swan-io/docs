...
:::tip Prevent renewal without canceling
If you want to keep the card usable until its expiry date but stop it from being renewed, use the `cancelPhysicalCardRenewal` mutation instead.
