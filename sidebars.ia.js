  ...
  accountsSidebar: [
    ...
    top("Reference", [
      ...
      cat("Country requirements", [
        doc("accounts/reference/country-requirements/france", "🇫🇷 France"),
        doc("accounts/reference/country-requirements/belgium", "🇧🇪 Belgium"),
        doc("accounts/reference/country-requirements/netherlands", "🇳🇱 Netherlands"),
        doc("accounts/reference/country-requirements/germany", "🇩🇪 Germany"),
        doc("accounts/reference/country-requirements/italy", "🇮🇹 Italy"),
        doc("accounts/reference/country-requirements/spain", "🇪🇸 Spain"),
      ], { link: "accounts/reference/country-requirements/index" }),
      doc("accounts/reference/company-onboarding-fields", "Company onboarding fields"),
      doc("accounts/reference/company-onboarding-fields-api-mapping", "Company onboarding API mapping"),
