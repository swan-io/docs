...
🪝 You can now [manage webhooks automatically with the API](/dev-tools/using-api/webhooks#event-handling-api).
...
📃 If a KBIS document for a newly-created company is refused at the end of a [French capital deposit process](/accounts/guides/onboarding/capital-deposits/#france), you can now upload a new one and we'll process it again.
...
The new rejection reasons are available in Sandbox using the [Event Simulator](/dev-tools/tools/event-simulator).