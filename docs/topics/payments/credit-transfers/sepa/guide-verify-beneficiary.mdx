...
The `beneficiaryVerification` query will be deprecated on October 9, 2025. [Migrate to Verification of Payee (VoP)](verification-of-payee) before the compliance deadline.
:::
