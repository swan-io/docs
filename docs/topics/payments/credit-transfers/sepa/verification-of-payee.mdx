...
VoP is applicable to all countries included in the SEPA zone. Payment Services Providers have varying implementation timelines based on their location:
...
<Tabs>
  ...
  <TabItem value="close" label="⚠️ ‎ Close match">
    **Result**: Partial match with name suggestion
