...
Fees on Swan accounts are booked as dedicated transaction types: fees Swan charges, and custom fees you charge your account holders.
...
| --- | --- |
| **Sufficient** to cover fee | Swan executes the fee transaction. The status changes to [`Booked`](/payments/concepts/transactions/statuses). |
