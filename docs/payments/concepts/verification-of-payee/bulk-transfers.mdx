...
:::info Requirements
Bulk credit transfers require [custom verification](/payments/concepts/verification-of-payee#option-2) using the [`verifyBeneficiary`](/payments/guides/credit-transfers/sepa/verify-beneficiary) mutation. The default verification flow doesn't support bulk payments.
:::
