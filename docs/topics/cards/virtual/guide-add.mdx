...
If you want to issue single-use virtual cards without having direct human interaction to consent and reveal card numbers, you must be the account holder (not available for end-users) and have [server-to-server consent](../../consent/guide-implement-s2s.mdx) implemented.
