...
Card packages is currently in private beta.
:::
...
You can assign one of the three standard insurance packages at the card product level. 
...
- [Configure Card packages package](guide-packages-integration.mdx)