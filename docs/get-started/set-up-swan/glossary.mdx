...
![Swan Data Model](../../images/topics/welcome/data-model.png)
...
## [Account onboarding](/topics/onboarding/) {#account-onboarding}
...
### [Company account onboarding](/topics/onboarding/company/) {#account-onboarding-company}

<CompanyOnboardingDefinition />

### [Individual account onboarding](/topics/onboarding/individual/) {#account-onboarding-individual}
...
### [Account holder](/topics/onboarding/account-holders/) {#account-holder}
...
### [Account funding](/topics/accounts/funding/) {#account-funding}
...
Read more about the Swan API in the [Developers](/dev-tools) section.

import IdempotencyDefinition from '../../topics/definitions/_idempotency.mdx';

### [Idempotency](/dev-tools/using-api/idempotency) {#idempotency}

<IdempotencyDefinition />

import PaginationDefinition from '../../topics/definitions/_pagination.mdx';

### [Pagination](/dev-tools/using-api/pagination) {#pagination}

<PaginationDefinition />

import RejectionsDefinition from '../../topics/definitions/_rejections.mdx';

### [Rejections](/dev-tools/using-api/errors-rejections) {#rejections}
...
### [Webhooks](/dev-tools/using-api/webhooks) {#webhooks}
...
## [Capital deposit](/topics/capital-deposits/) {#capital-deposit}

<CapitalDepositDefinition /> 

***

## [Card](/topics/cards/) {#cards}
...
### [Virtual cards](/topics/cards/virtual/) {#cards-virtual}

<VirtualCardDefinition /> 

### [Physical cards](/topics/cards/physical/) {#cards-physical}

<PhysicalCardDefinition /> 

### [Digital cards](/topics/cards/digital/) {#cards-digital}
...
## [IBAN](/topics/accounts/ibans/) {#ibans}
...
## [Merchant](/topics/merchants/) {#merchants}
...
## [Payment](/topics/payments/) {#payments}

<PaymentDefinition />

import PaymentControlDefinition from '../../topics/definitions/_payment-control.mdx';

### [Payment control](/dev-tools/using-api/payment-control) {#payment-control}
...
Several Swan features may require payment mandates, including [account funding](/topics/accounts/funding/#mandates), [accepting payments](/topics/merchants/online/sdd/#mandates), and [received payment mandates for SEPA Direct Debit](/topics/payments/direct-debit/#mandates).
...
## [Supporting documents](/topics/accounts/documents/) {#supporting-documents}
...
## [Transaction](/topics/payments/#transactions) {#transactions}
