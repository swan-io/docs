...
Review the **sequence diagram** on the [general capital deposit page](../index.mdx) to see the interactions in more details, plus find information about **statuses**, **shareholders**, and more.
:::
...
## Step 2: Finalize account creation {#finalize-account-creation}
...
1. Shareholders need to complete the account onboarding process. [Monitor their progress](../../onboarding/overview/guide-get-onboarding-info.mdx) if needed.
...
## Step 3: Verify account holders {#verify-account-holders}
...
## Step 4: Upload capital deposit documents {#upload-documents}
...
## Step 6: Validate and update case {#validate-case}
...
- Updates the [case status](../index.mdx#api-case-statuses) to `WaitingForShareDepositCertificate` so it gets sent to the notary.

## Step 7: Upload share deposit certificate {#upload-certificate}
...
## Step 9: Transfer funds to company account {#transfer-funds-company}
