...
If you're subscribed to the `Card.Updated` [webhook](/dev-tools/using-api/webhooks#events-cards), you'll receive a notification when the physical card status changes to `ToRenew`.
