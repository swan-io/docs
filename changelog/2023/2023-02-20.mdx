...
💰 On March 1 2023, we will start charging banking fees directly on your customers' Swan accounts.
This is the first phase of our [billing project](/accounts/concepts/billing).
...
📃 You can now use the `accountStatement` query to [return an account statement](/accounts/concepts/account) from its `id`.
