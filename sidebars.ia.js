...
module.exports = annotateAudience(annotate({
  ...
  accountsSidebar: [
    ...
    top("Concepts", [
      ...
      cat("Billing", [
        ...
        doc("accounts/concepts/billing/regulated-fees", "Fee billing rules"),
  ...
  paymentsSidebar: [
    ...
    top("Guides", [
      ...
      ], { link: "payments/guides/credit-transfers/index" }),
      cat("Direct debit", [
      ...
      ], { link: "payments/guides/direct-debit/index" }),
      cat("Payment cards", [
      ...
      cat("Payment operations", [
        ...
        ], { link: "payments/guides/payment-operations/generate-transaction-statement/index" }),
        cat("Export transaction data", [
          doc("payments/guides/payment-operations/export/from-the-dashboard", "From the Dashboard"),
          doc("payments/guides/payment-operations/export/using-the-api", "Using the API"),
        ], { link: "payments/guides/payment-operations/export/index" }),
  ...
  usersSidebar: [
    ...
    top("Guides", [
      cat("User operations", [
        ...
        cat("Get user info", [
          doc("users/guides/user-operations/get-info/from-the-dashboard", "From the Dashboard"),
          doc("users/guides/user-operations/get-info/one-user", "One user"),
          doc("users/guides/user-operations/get-info/multiple-users", "Multiple users"),
          doc("users/guides/user-operations/get-info/user-list", "User list"),
          doc("users/guides/user-operations/get-info/identifications", "Identifications"),
          doc("users/guides/user-operations/get-info/latest-identification", "Latest identification"),
        ], { link: "users/guides/user-operations/get-info/index" }),
      ]),
      cat("Consent", [
