...
Refer to the [🇫🇷 France](/topics/cards/physical/#hubs-france) and [🇪🇸 Spain](/topics/cards/physical/#hubs-spain) hubs for more detailed information on delivery types and destinations served by these shipping providers. 
