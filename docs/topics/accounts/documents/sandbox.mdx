...
With the supporting document collection ID, use the Event Simulator to [request a supporting document](./index.mdx#document-purposes-types) with a specific purpose.
