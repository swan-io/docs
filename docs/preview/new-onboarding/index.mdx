...
This API is in active development and will be available in Q4 2025.
:::
...
- `accountInfo`: Account-level details (`country`, `name`, `intendedUsage`).
- `accountAdmin`: Individual's personal information (`email`, `employmentStatus`, `monthlyIncome`, `address`, etc.).
