...
The status flows for received <Term id="payment-mandates">payment mandates</Term> and <Term id="direct-debit">direct debit</Term> <Term id="transactions">transactions</Term>.
