...
Download a PDF of an account's bank details for the main <Term id="ibans">IBAN</Term> or virtual IBANs, with the API or from your Dashboard.

Download a PDF of your [bank details](/accounts/concepts/account/documents#bank-details) for the account's main IBAN, a list of virtual IBANs, or specific virtual IBANs with the API.
