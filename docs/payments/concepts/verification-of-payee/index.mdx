...
<Tabs>
  ...
  <TabItem value="close" label="⚠️ Close match" id="vop-close">
    #### Close match result
...
<div className="row margin-bottom--lg">
  ...
  <div className="col col--6">
    <div className="card" style={{height: '100%', backgroundColor: '#f0f9f0', border: '1px solid #d4edda'}}>
      ...
      <div className="card__body">
        <p><strong>Use [the `verifyBeneficiary` mutation](/payments/guides/credit-transfers/sepa/verify-beneficiary) for full control over verification presentation</strong></p>
        <ul>
        ...
        <p><a href="/payments/guides/credit-transfers/sepa/verify-beneficiary">Learn how to verify beneficiary details →</a></p>
      </div>
    </div>
  </div>
</div>
...
<Tabs>
  ...
  <TabItem value="close" label="⚠️ Close match" id="custom-ux-close">
...
→ Learn how to [verify beneficiary details](/payments/guides/credit-transfers/sepa/verify-beneficiary) using the `verifyBeneficiary` mutation  
→ Configure [bulk credit transfers with VoP](/payments/concepts/verification-of-payee/bulk-transfers) for high-volume use cases  
→ Understand how Swan handles [incoming VoP requests](/payments/guides/credit-transfers/sepa/incoming-vop-requests) automatically