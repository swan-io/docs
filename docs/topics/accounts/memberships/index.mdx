...
Names must start with a letter. Separators (hyphen, apostrophe, and space) must be followed by at least one letter and can't appear at the start or consecutively. Names may optionally end with an apostrophe.
