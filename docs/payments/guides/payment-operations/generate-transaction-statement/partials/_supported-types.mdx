...
Transaction confirmation statements are **different from account statements**, which include all booked transactions and fees. To cover all booked transactions over a period, [generate an account statement](/accounts/guides/account-operations/generate-statement).
