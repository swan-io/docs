...
Starting October 9, 2025, Swan automatically includes [Verification of Payee (VoP)](verification-of-payee) in all SEPA Credit Transfers. Consider integrating the [`verifyBeneficiary` mutation](verification-of-payee) for optimal user experience.
:::
