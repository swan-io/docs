...
Since, the account has reached the €150 lifetime limit, Swan will automatically reject additional incoming transfers.
...
These restrictions primarily impact first transfers during the account holder verification process when accounts are in `Limited` status.
:::
