...
You can assign one of the [three standard insurance packages](/topics/cards/overview/card-insurance) at the card product level. 
...
- [Configure card insurance package](../overview/guide-insurance-integration.mdx)