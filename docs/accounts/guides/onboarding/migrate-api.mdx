...
- [Individual onboarding fields: API mapping](/accounts/reference/onboarding/individual-onboarding-fields#api-mapping)
- [Company onboarding fields: API mapping](/accounts/reference/onboarding/company-onboarding-fields-api-mapping)

The mapping tables show each previous field alongside its current equivalent.
The mapping tables are available until the previous mutations are retired on 31 December 2026.
...
### Step 1: Update mutation names {#step-1}
...
### Step 2: Update input structure {#step-2}
...
### Step 3: Handle new required fields {#step-3}
...
- [Individual onboarding fields](/accounts/reference/onboarding/individual-onboarding-fields#fields)
- [Company onboarding fields](/accounts/reference/onboarding/company-onboarding-fields#fields)

### Step 4: Update response handling {#step-4}
...
### Step 5: Update registry data handling (French company onboardings) {#step-5}
...
| 30 September 2026 | Creating onboardings with the previous mutations stops. |
| 31 December 2026 | Previous mutations and queries removed. |
...
- Create a company onboarding with `relatedIndividuals` (at least one <Term id="legal-representative">legal representative</Term> and one <Term id="ubo">UBO</Term>).
...
- Confirm that [webhook payloads](/build/using-api/webhooks) for `Onboarding.Created` and `Onboarding.Updated` still match your expectations.
