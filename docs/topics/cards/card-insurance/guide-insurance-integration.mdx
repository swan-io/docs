...
Swan automatically creates a [card insurance subscription](/topics/cards/card-insurance/#insurance) when a new card is issued, if the following conditions are met:
