...
At least one legal representative and one UBO are required to finalize a company onboarding. For a complete list of fields, country-specific requirements, and conditional rules, refer to the [company onboarding field reference](/accounts/reference/company-onboarding-fields).
...
Company onboarding collects different fields per country (account, administrator, company, related individuals, and related companies), with required/optional/conditional rules and API mapping tables. Those reference tables now live in [Company onboarding fields](/accounts/reference/company-onboarding-fields).
