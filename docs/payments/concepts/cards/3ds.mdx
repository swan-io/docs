...
All Swan <Term id="cards">cards</Term>, including single-use virtual cards, are subject to 3DS compliance; however, because single-use virtual cards require consent when being created, 3DS is more seamless.
