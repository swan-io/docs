...
1. Add all the information you'd like to review.
    - The sample query uses several `transactions` query options, including filtering for `Booked`, `amount` and `isBeforeExecutionDate` (line 3-6).
...
```graphql {3-6,17-21,25-29,32} showLineNumbers
      ...
      "edges": [
        {
          "node": {
            ...
            "statusInfo": {
              ...
              "bookingDate": "2025-04-15T18:00:07.404Z",
              "valueDate": "2025-04-15T18:00:07.404Z"
            },
        ...
        },
        {
          "node": {
            ...
            "statusInfo": {
              "status": "Booked",
              "__typename": "BookedTransactionStatusInfo",
              "bookingDate": "2025-04-04T08:34:51.556Z",
              "valueDate": "2025-04-04T08:34:51.556Z"
            },
            "type": "CardOutDebit",
            "statementCanBeGenerated": false
          }
