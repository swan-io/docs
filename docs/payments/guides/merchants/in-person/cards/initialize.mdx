...
Set up a connection token provider, then discover and connect to the reader.

## Prerequisites {#prerequisites}

You need all of the following to initialize your device.

- The [Stripe Terminal SDK](./setup.mdx) installed in your app.
...
<a href="https://explorer.swan.io?query=&tab=api" className="explorer-badge">Open in API Explorer</a>
...
#### Wire up the token provider on React Native {#wire-provider-react-native}
...
#### Wire up the token provider on iOS {#wire-provider-ios}
...
#### Wire up the token provider on Android {#wire-provider-android}
...
### Discover and connect to the reader on React Native {#connect-reader-react-native}
...
### Discover and connect to the reader on iOS {#connect-reader-ios}
...
### Discover and connect to the reader on Android {#connect-reader-android}
...
→ [Create in-person card payments](./create-payments.mdx)
