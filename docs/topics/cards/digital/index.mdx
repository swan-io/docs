...
The resource ID in the event is a `digitalCardId` that can be used with the [query `digitalCard(digitalCardId: ...)`] (https://api-reference.swan.io/queries/digital-cardto) retrieve the latest digital card data.
