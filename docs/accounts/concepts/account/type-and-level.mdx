...
| `Limited` + `PaymentService` | The account's main IBAN is displayed.<br />Money can be added to the account.<br /><br />Account holder verification isn't complete.<br />Payments can't be made from the account.<br />Incoming transfers are subject to the [Limited account transfer restrictions](#limited-account-restrictions). |
