...
Specific coverage varies by **insurance plan**. To consult the details of a card's insurance coverage, please consult your **terms and conditions** or submit a request to Swan Support.
:::
...
Depending on the type of claim, cardholders can seek support through the Swan, our claims portal, or assistance provider:
...
- [Retrieve card package level](guide-packages-integration.mdx)