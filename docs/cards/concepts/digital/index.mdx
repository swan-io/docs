...
![Add to Apple Wallet and Add to Google Wallet badges](../../../images/cards/cards-digital-wallets.png)
...
1. If cardholders start manual provisioning but don't complete it, you can [help them transition to in-app provisioning](/cards/guides/digital/transition-provisioning) using the `activateDigitalCard` mutation (requires Apple Pay or Google Pay certification).

## Renewing digital cards {#auto-renew}

Swan takes care of updating digital cards with Apple Pay and Google Pay.
This requires no action from you or your cardholders.
...
Use the Partner Support Request form on your Dashboard, specifying that you'd like to activate in-app provisioning for digital payments. The team will help you get started.
