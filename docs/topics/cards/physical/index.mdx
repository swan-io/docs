...
**France is Swan's default hub**, so if you're not located in Spain or Portugal and you don't choose Spain intentionally, your cards will be printed and shipped from France.
[Choose your hub](./guide-print.mdx#choose-hub) with the API.

:::info Two card products
The printing hub is defined by the [card product](../index.mdx#card-product).
...
| Tracked non-group delivery | Northern Europe and other locations | DHL |
| Untracked non-group delivery | Northern Europe and other locations | La Poste |
