...
For when to use consent notifications and how they work, including the Web Banking exception, refer to [notification preferences](/users/concepts/consent#notifications).
...
The fallback applies to all flows, including 3DS, and users can also choose to receive a text message instead with a button on the consent screen.
This timeout complies with [3-D Secure (3DS)](/payments/concepts/cards/3ds#3ds) requirements.
:::
