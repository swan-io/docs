...
Shipping costs depend on the destination. International shipments may incur additional fees.  
Delivery type, such as group or non-group, tracked or untracked, can also affect the cost.
:::
