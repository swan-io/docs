...
Follow the [guide to create a capital deposit case](/accounts/guides/capital-deposits/create-case), which includes full API mutation examples.
...
Follow the [guide to upload required documents](/accounts/guides/capital-deposits/upload-documents) to generate URLs and upload documents, which includes full API mutation examples.
...
Alternatively, they can access the IBAN associated with their Swan account through the Web Banking user interface, or you can access it on the Dashboard and share it with them.
...
Follow the [guide to upload required documents](/accounts/guides/capital-deposits/upload-documents) to generate an upload URL and upload your KBIS.
