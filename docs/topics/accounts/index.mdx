...
| --- | --- |
| `Limited` + `E-Money` | <ul><li>The account can be used to:<ul><li>Invite account members.</li><li>Add virtual cards.</li></ul></li><li>The account doesn't have its main IBAN.</li><li>Payments **can't** be made from the account.</li></ul> |
| `Limited` + `Payment Services` | <ul><li>The legal representative finished [identification](../users/identifications/index.mdx).</li><li>Account holder verification isn't complete yet.</li><li>The account has its main IBAN.</li><li>You can add money to the account.</li><li>Payments **still can't** be made from the account.</li></ul> |
