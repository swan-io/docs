...
When you initiate a credit transfer using a token, the same membership rights apply as described in [Beneficiaries permissions](/payments/concepts/credit-transfers#beneficiaries-permissions).
