...
- A **merchant profile** with the status **Enabled**. If you don't have one yet, [request a merchant profile](../../profiles/guide-request.mdx) first.
...
| `WaitingForInformation` | Swan needs more information. Refer to [provide missing information](../../guide-missing-information.mdx) to learn what to submit. |
...
:::tip
Subscribe to merchant webhooks to monitor changes in payment method status. Review the full list of [merchant webhooks](../../index.mdx) or subscribe to them from your **Dashboard** > **Developers** > **Webhooks**.
:::