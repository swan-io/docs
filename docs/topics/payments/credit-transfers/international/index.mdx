...
<details>
  <summary>**Blocked countries** for incoming and outgoing transfers</summary>
  <div>
...
<details>
  <summary>Countries requiring a **stricter review** for incoming transfers</summary>
  <div>
<ol>
<li>Afghanistan</li>
<li>South Africa</li>
...
<li>Saint Helena</li>
<li>Ascension and Tristan da Cunha</li>
<li>Saint Lucia</li>
...
| 🇺🇾 UYU | Uruguayan Peso | `rail` | 4 |
| 🇻🇳 VND | Vietnamese Dong | `rail` | 2 |
