...
1. Please use our [Partner Support Request form](https://supportform.swan.io/) available on your Dashboard, stating that you'd like to begin the custom design process. Include how many cards you'll print in the first batch (1000 minimum).
...
You need Swan's approval before you can customize your card or packages. To request it, please use the [Partner Support Request form](https://supportform.swan.io/) available on your Dashboard.
:::
...
You can also request custom colors outside this list. Please use the [Partner Support Request form](https://supportform.swan.io/) available on your Dashboard to discuss options.
