...
They accept <Term id="payments">payments</Term> through a simple terminal app in just a few taps.
...
If it doesn't arrive within **5 business days**, reach out through our [Partner support request form](https://partner-support.swan.io/hc/en-gb/requests/new).
:::
