...
```flowmap
{
  ...
  "nodes": [
    ...
    { "title": "Verification renewal", "to": "/accounts/concepts/onboarding/verification-renewal", "desc": "Periodic Re-KYC that keeps account holders up to date." },
    { "title": "Account holders", "to": "/accounts/concepts/account-holders", "desc": "The verified entity onboarding produces." }
  ]
}
```
...
- [Individual onboarding](/accounts/guides/onboarding/individual) and [company onboarding](/accounts/guides/onboarding/company) guides
- [Manage onboardings](/accounts/guides/onboarding/manage-onboardings)
- [Account holders](/accounts/concepts/account-holders)
