...
They can **update their phone number independently** by tapping *New phone number? Update it* at the start of any login or consent flow and following the prompts.
...
6. Enters their **birth information**: birth city, postal code, and country, and nationality.
    - If you include this information when [creating their sign-up link](../../developers/using-api/authentication/guide-get-token-user.mdx#url-parameters-optional), they won't need to enter it again.
