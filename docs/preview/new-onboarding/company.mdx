...
All supporting documents requested during onboarding must be provided to finalize the onboarding.
:::
...
The `relatedIndividuals` array is required for all countries. At least one Legal Representative and one Ultimate Beneficial Owner are required to finalize a company onboarding. The same individual can fulfill both roles depending on the `type`.
