...
audience:
  - dev
counterpart: /accounts/guides/onboarding/look-up-onboardings
related:
  - /accounts/guides/onboarding
  - /accounts/guides/onboarding/look-up-onboardings
...
These operations apply to both individual and company onboardings: monitor progress, list required <Term id="supporting-documents">supporting documents</Term>, export onboarding data, and finalize an onboarding.
...
Onboarding IDs are also listed on your Dashboard: [look up onboardings from the Dashboard](/accounts/guides/onboarding/look-up-onboardings).
...
You can export onboarding data from the Dashboard or with the API. See **[Export onboarding data](/accounts/guides/onboarding/export)** for both paths.
