...
[Review the requirements](/payments/concepts/merchants/sepa-direct-debit#mandates) for SEPA <Term id="direct-debit">Direct Debit</Term> payment mandates if needed.
...
1. Choose `Recurrent` or `OneOff` (line 5).
    - [`OneOff` payment mandates](/payments/concepts/merchants/sepa-direct-debit#mandates-oneoff) can only be used once.
...
1. Choose either Core or B2B in your [mandate name](/payments/concepts/merchants/sepa-direct-debit#mandates-info) (line 13).
