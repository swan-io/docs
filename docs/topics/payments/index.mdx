...
### Transaction statements {#transactions-statements}
...
| `Generated` | Transaction statement was generated successfully. Swan emailed you a link to download the statement. |
| `Failed` | The statement couldn't be generated. You can try again. |
| `Expired` | Transaction statement was generated successfully. However, it wasn't opened within seven days and therefore expired. |
...
- Transactions:
    ...
    - [Generate a transaction statement](./overview/guide-generate-transaction-statement.mdx)