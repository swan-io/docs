...
Mastercard requires Swan to accept or reject all transactions.
...
Using payment control, you can let Swan know whether you **accept or reject all card transactions** within your project.
...
Add and update payment control with the API or on your Dashboard.

- On your **Dashboard**, go to **Developers** > **Payment control**. Add your information and click **Save**.
- With the **API**, call the `updateCardPartnerControl` mutation with your information.
