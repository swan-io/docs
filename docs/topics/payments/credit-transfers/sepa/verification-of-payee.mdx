    ...
    <div className="card" style={{height: '100%', backgroundColor: '#f0f9f0', border: '1px solid #d4edda'}}>
      ...
      <div className="card__body">
        ...
        <ul>
          ...
          <li>Best for: Enhanced UX and complex payment flows.</li>
        </ul>
      </div>
    </div>
  </div>
...
3. **Inform the end-user**: Display appropriate messaging based on the verification result.
4. **User proceeds**: The end-user can choose to proceed with the payment regardless of the result.
5. **Use token**: Add the beneficiary token to complete the credit transfer.
