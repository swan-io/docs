...
In certain cases, Swan requires supporting documents to justify large or suspicious transactions.
...
You might choose to provide supporting documents early for large transactions or transactions that differ from the account's regular usage.
