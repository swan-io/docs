...
:::caution Deprecated
This page documents the legacy onboarding API. It is preserved as a read-only reference. Refer to [account onboarding enhancements](../../../index.mdx) for the current onboarding API.
:::

Update company onboardings using the API.

:::caution Updating UBO fields
Fields about an ultimate beneficial owner (UBO) can't be updated incrementally. To update any UBO field, you must resubmit all UBO fields in full.
