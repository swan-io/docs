...
[Digital wallet payments](/cards/concepts/digital) (like Apple Pay or Google Pay) bypass these limits because they use [Strong Customer Authentication (SCA)](/topics/users/consent#sca) through a password or biometrics. 
...
With 3DS, cardholders are required to perform [Strong Customer Authentication](/topics/users/consent#sca) before finalizing their payment.
...
2. 3DS consent respects your configured [notification preferences](/topics/users/consent#notifications). If you've integrated consent notifications, you'll receive notifications for 3DS payments that you can forward to your users through your own channels.
