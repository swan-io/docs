...
Instead, fees are included on the standard [monthly account statement](../index.mdx#statements), and an annual statement is provided automatically once a year.
