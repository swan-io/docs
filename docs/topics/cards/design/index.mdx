...
Metal cards are available as part of the Premium card package.

These 22-gram cards are made from stainless steel and tungsten, with a slightly textured dark protective layer on each side and exposed metal edges.

Your logo will be laser-printed on the cards, revealing the metal underneath.

Card design example is not yet available.
