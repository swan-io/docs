---
title: Update a shareholder's capital deposit amount
audience:
  - dev
related:
  - /accounts/guides/capital-deposits
  - /accounts/guides/capital-deposits/update-company
---

# Update a shareholder's capital deposit amount

Update the <Term id="capital-deposit">capital deposit</Term> amount associated with a shareholder on a case with the API.
