...
Swan supports the following payee identification types with a Swan [Bank Identifier Code (BIC)](/topics/accounts/ibans/#local):
...
→ Understand the complete VoP ecosystem with [Verification of Payee overview](/topics/payments/credit-transfers/sepa/vop/verification-of-payee)