...
<p className="ia-lede">A card payment is first authorized, then cleared. Learn how authorizations are created, expire, and are released, how debits and credits clear, and which capture types exist, with worked examples from real <Term id="merchants">merchant</Term> flows.</p>
