...
- **After 8 weeks and up to 13 months:** Only possible if the transaction is unauthorized or there's no valid mandate. The request requires additional checks and evidence. The receiving/creditor bank may accept or reject the claim.
