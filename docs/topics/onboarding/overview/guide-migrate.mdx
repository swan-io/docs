...
To avoid disruption, migrate to the current API before 30 September 2026.
:::
...
The mapping tables will be available until the deprecated v1 mutations are removed on 31 December 2026.
...
After 31 December 2026, you can't update or finalize onboardings through the deprecated mutations. Make sure your integration is fully migrated by then.
...
| 30 September 2026 | You can't create new v1 onboardings. |
| 31 December 2026 | Deprecated v1 queries and mutations removed. |
