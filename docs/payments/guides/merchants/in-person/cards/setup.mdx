...
1. After submitting, Apple sends a confirmation email. Follow Apple's guide to add the Tap to Pay capability to your App ID, download the provisioning profile, and configure the entitlements file.
   ...
   :::info Apple marketing guidelines
   Apple emails you the marketing guidelines separately, along with the technical configuration assets, as part of this entitlement process.
   :::
...
Install the SDK using the steps on this page, not Stripe's.
...
### Install the Stripe Terminal SDK on React Native {#install-sdk-react-native}
...
### Install the Stripe Terminal SDK on iOS {#install-sdk-ios}
...
#### Install the SDK on iOS with CocoaPods {#install-sdk-ios-cocoapods}
...
#### Install the SDK on iOS with Swift Package Manager {#install-sdk-ios-spm}
...
#### Install the SDK on iOS manually {#install-sdk-ios-manual}
...
### Install the Stripe Terminal SDK on Android {#install-sdk-android}
...
#### Install the SDK on Android with Kotlin build files {#install-sdk-android-kotlin}
...
#### Install the SDK on Android with Groovy build files {#install-sdk-android-groovy}
...
### Request location permissions on React Native {#permissions-react-native}
...
### Request location permissions on iOS {#permissions-ios}
...
### Request location permissions on Android {#permissions-android}
...
→ [Request a merchant profile](../../profiles/request.mdx)