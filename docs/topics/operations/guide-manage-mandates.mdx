...
This guide helps partner support teams answer user questions about SEPA Direct Debit mandates. It covers checking mandate details in the Dashboard, [troubleshooting rejected payments](#troubleshoot-rejected-direct-debits), and knowing when to [raise a Swan Support request](#contact-swan-support). For full product documentation, see the [SEPA Direct Debit overview](/topics/payments/direct-debit/) and [add a payment mandate](/topics/payments/direct-debit/guide-add-mandate/) guides. For user-facing explanations, share [SEPA Direct Debit mandates](https://support.swan.io/hc/en-150/articles/19637943123101) and [Direct debit overview](https://support.swan.io/hc/en-150/articles/24510545177501).
...
| `Canceled` | The mandate has been permanently canceled. | Future debits from this creditor are rejected. The user may need a new mandate or updated instructions from the creditor. This can only be actioned through a Swan Support request. |
...
1. If they can't access or complete it, raise a [Swan Support request](https://partner-support.swan.io/hc/en-gb/requests/new) with the required mandate information.
...
Swan checks all pending direct debit instructions at **6:00 AM CET/CEST** on the day the payment is due, following the [full execution logic](/topics/payments/direct-debit/#received-instructions-execution). At that point, Swan checks that:
