...
- [`initiateMerchantPaymentCollection`](/topics/merchants/online/idd/guide-initiate/) to prevent duplicate Internal Direct Debit payment collections.
...
- [`initiateFundingRequest`](/topics/accounts/funding/guide-initiate-request/) to prevent duplicate account funding requests.
...
- [Errors & rejections](/dev-tools/using-api/errors-rejections) · [Pagination](/dev-tools/using-api/pagination)
