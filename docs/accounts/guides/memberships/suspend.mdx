...
Suspending a membership doesn't require consent; [resuming it](/accounts/guides/memberships/resume) does.

If you use Swan's Web Banking interface, your users can also block <Term id="account-membership">account memberships</Term> from their Web Banking accounts.
