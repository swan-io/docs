...
SCA integration is relevant when your partner has a mobile app and users perform all actions from the mobile app. This improves UX by keeping users inside your mobile app rather than redirecting them to an external browser.
