...
Limited accounts have additional incoming transfer restrictions:

- Individual incoming SEPA Credit Transfers exceeding €50 are automatically rejected.
- Incoming SEPA Credit Transfers that would cause the account balance to exceed €150 are automatically rejected.
