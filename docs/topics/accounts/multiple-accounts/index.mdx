...
:::info Coming soon
The web banking settings feature to control `canOpenAccount` is not yet available in the Dashboard. This functionality will be released in a future update.
:::
