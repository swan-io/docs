...
1. Allow you to **act as a user within your project**, sometimes referred to as [impersonation](../authentication/guide-impersonate.mdx).
...
Learn more about project access tokens, including how to [get them](../authentication/guide-get-token-project.mdx), in the [authentication](../authentication/index.mdx) section.

## Sandbox and Live projects {#types}
...
Note that you can only **delete or clear Sandbox projects**.
For regulatory reasons, it's **not possible to delete Live projects** or clear data from a Live project.
...
| `MeetingScheduled` | Partner schedules a meeting<br/><br/>**Next**: Partner schedules meeting with Swan | ☒ No | ☒ No |
