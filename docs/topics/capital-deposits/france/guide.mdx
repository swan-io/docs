...
Review the **sequence diagram** on the [general capital deposit page](../index.mdx#diagram) to see the interactions in more details, plus find information about **statuses**, **shareholders**, and more.
:::
