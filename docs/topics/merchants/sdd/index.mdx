...
<DirectDebitTable directDebitScheme="Core" creditorType="Creditor" psp="the debtor's PSP" incomingOutgoing="3-5 business days after execution date (example: insufficient funds, debtor account closed)" />
