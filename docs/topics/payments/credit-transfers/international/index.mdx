...
An outgoing International Credit Transfer might be **rejected** for several reasons, among others:
- The transfer may exceed the [maximum transaction amount limit](/topics/payments/credit-transfers/international/#transfer-limits). 
- Some of the account or bank details might be incorrect.
