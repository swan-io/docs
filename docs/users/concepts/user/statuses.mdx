...
| `Deactivated` | You can deactivate users [with the API](/users/guides/overview/deactivate), and Swan can also assign this status.<br /><br />Deactivated users can't access Swan or use Swan services. Phone numbers attached to `Deactivated` users can be assigned to someone else. |
