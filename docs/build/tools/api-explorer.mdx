...
API Explorer is available for the Sandbox environment only.
...
![Image of API Explorer with three blocks called out](../../images/build/tools/explorer-overview.png)

## Block 1: Top navigation {#top-nav}

1. Swan exposes two APIs:
    - Use the **Live API** to perform all of your real work with Swan.
    - Use the [**Testing API**](/build/tools/testing-api) in partnership with the [**Event Simulator**](/build/tools/event-simulator) to simulate events that must include other people, such as consent and authentications.

**Open the menu to switch** between tokens and projects by clicking around your logo or user type:

2. Switch between [**access tokens**](/build/using-api/authentication#tokens):
...
![Focused screenshot of top navigation with project and token menu open](../../images/build/tools/explorer-top-nav.png)
...
![Focused screenshot of three side modules](../../images/build/tools/explorer-module-options.png)
...
![Focused screenshot of Explorer body section](../../images/build/tools/explorer-body.png)
...
- [Testing the API](/build/tools/testing-api) · [Event simulator](/build/tools/event-simulator) · [Test tools guide](/build/tools/test-tools-guide)
