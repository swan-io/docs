...
Everything from **what to include in your API request** to how to ask **users to verify their identity** to whether Swan **requires certain ID numbers or documents** depends on the [account country](/accounts/concepts/account#account-country).
...
<table>
  ...
  <tr>
    ...
    <td>Partner uploads new documents<br /><br />💡 *If needed, [get a list of required documents](/accounts/guides/onboarding/#get-list). Then, [upload missing documents](/accounts/guides/documents/upload-onboarding).*</td>
    <td><center>`WaitingForInformation`</center></td>
    <td><center>`WaitingForDocuments`</center></td>
  </tr>
  <tr>
...
- [Individual onboarding fields](/accounts/reference/individual-onboarding-fields#fields)
- [Company onboarding fields](/accounts/reference/company-onboarding-fields#fields)
