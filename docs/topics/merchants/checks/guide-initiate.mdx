...
🔎 [Open the mutation in API Explorer](https://explorer.swan.io?query=%3D&tab=api)
...
1. **Merchant**:
    1. The merchant sends the check to Swan's check provider by physical mail within 30 days of the `initiateMerchantPaymentCollection` mutation call.
1. **Swan's check provider**:
    1. The check provider processes the check, after which the status changes to `Booked`. This can take up to two days.
