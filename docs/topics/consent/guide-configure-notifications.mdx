...
If your response is anything other than a 200 OK HTTP, or there's no response at all, Swan cancels the consent and redirects your user.
:::
...
1. Choose the preferred channel:
    1. `Sms`: Swan sends a text message to the user with the SCA link to open on their mobile device.
    1. `App`: You receive a notification, then send the SCA link to your user yourself.

### Mutation {#mutation}

🔎 [Open the mutation in API Explorer](https://explorer.swan.io?query=%3D%3D&tab=api)
...
![Image of Dashboard consent notification](../../images/topics/consent/consent-notification-dash.png)
