...
| `Canceled` | When a `CapitalDepositCase` is `Canceled`, the shareholder is also `Canceled`.<br/><br/>If an account was already created for the shareholder, the account is closed automatically. |
