...
🔎 **In 1 week**, we're generating [Bank Details documents](/accounts/concepts/account/bank-details) for all accounts created before 16 November 2023, which weren't available automatically when we launched this feature.
