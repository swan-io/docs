...
Belgian accounts require identity verification following Swan's [identification](/topics/users/identifications/) process. The recommended [identification levels](/partnership/document-center/identity/) vary by account type.

#### Individual accounts

| Account country | Recommended level for individuals | Other supported levels |
|---|---|---|
| 🇧🇪 Belgium | QES | Expert + first transfer<br />PVID |

:::info Identification level
Swan may change from QES to Expert to align with the Netherlands when launching Belgian IBANs.
:::
...
| `residencyAddress` | <Opt /> | Full Belgian residency address object |
