...
1. Add the `fnciInfo` to the success payload (lines 15-21). Refer to the explanatory content to [learn about FNCI and their verification results](/payments/concepts/merchants/french-checks#fnci).
