...
| --- | :---: | --- |
| **Business details** | <Req /> | Required. The merchant's name, product type (`product`, `services`, `digital goods`, or `donations`), and a short description of their activity. |
...
|  | 🇫🇷<br/>France | 🇩🇪<br/>Germany | 🇳🇱<br/>Netherlands | 🇪🇸<br/>Spain | 🇮🇹<br/>Italy |
