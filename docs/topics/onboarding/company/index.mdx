...
Swan allows two types of ultimate beneficial owners (UBOs):

- Ownership of capital
- Legal representative

#### Ownership of capital {#ubo-owner}

An *ownership of capital* UBO is an owner of a company holding more than 25% of that company, whether directly or indirectly.
Providing information for **all** UBOs owning 25% or more of a company is a **legal requirement**.

#### Legal representative {#ubo-legal}

If a company doesn't have any UBOs who hold more than 25% of the company, they still need to provide Swan with at least one UBO.
Swan considers this person as the default UBO and therefore the company's legal representative.

| UBO type | Explanation | Submitting UBO information |
| --- | --- | --- |
| Ownership of capital | Owns 25% or more of the company. | <ul><li>**API**: set `type` to `HasCapital`</li><li>**Onboarding form**: for type of control exercised, choose `Ownership of capital`</li></ul> |
| Legal representative | Doesn't own 25% or more of the company, but serves as the company's legal representative and owner for Swan. | <ul><li>**API**: set `type` to `LegalRepresentative`</li><li>**Onboarding form**: for type of control exercised, choose `Legal representative`</li></ul> |
