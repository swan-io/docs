...
You can also change the documents you already uploaded as long as the [document status](/accounts/reference/onboarding/capital-deposit-reference#documents-statuses) remains `Uploaded`.
