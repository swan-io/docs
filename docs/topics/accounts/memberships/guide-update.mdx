...
- You have a [**user access token**](../../../developers/using-api/authentication/index.mdx#tokens-user) associated with the account membership you're updating because updating a membership is a [sensitive operation](../../consent/index.mdx#sensitive).
