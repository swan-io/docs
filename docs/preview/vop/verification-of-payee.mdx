...
#### Bulk Credit Transfer requirements
    ...
    <div className="card" style={{height: '100%', backgroundColor: '#f0f9f0', border: '1px solid #d4edda'}}>
      ...
      <div className="card__body">
        ...
        <ul>
          ...
          <li>Required for bulk payment flows.</li>
          <li>Best for: Enhanced UX and high-volume use cases.</li>
        </ul>
        <p><a href="/preview/vop/guide-verify-beneficiary">Learn how to verify beneficiary details →</a></p>
      </div>
    </div>
  </div>
</div>
...
1. **Verify beneficiary**: Call [the `verifyBeneficiary` mutation](/preview/vop/guide-verify-beneficiary#step-1) - include the `accountId`, IBAN, and account holder name.
...
VoP applies to Standing Orders with these differences:
