...
<p className="ia-lede">Swan's three card formats, the order they're created in, and how cards attach to <Term id="account-membership">account members</Term>.</p>
...
Card statuses depend on the card format: refer to [virtual](/cards/concepts/virtual/statuses), [physical](/cards/concepts/physical/statuses), and [digital](/cards/concepts/digital/statuses) card statuses.
...
![Image displaying connection between account membership, virtual card, then digital and physical cards](../../images/cards/cards-types.png)

1. Create account memberships before creating cards.
1. Create virtual cards before physical cards.
1. Create physical and digital cards. Physical cards aren't required to create digital cards. You can add a virtual card directly into your favorite digital wallet.

Consider the example of Kafka Tamura:

![Image displaying possible timeline between creating a virtual card, adding a digital card, and deciding to order a standard physical card](../../images/cards/cards-timeline.png)
...
![Image displaying connection between account holder, account, multiple account memberships, and multiple cards](../../images/cards/cards-flow-multiple.png)

1. MyBrand is a verified <Term id="account-holder">account holder</Term> with a company account.
...
![Image displaying connection between account holder, account, one account membership, and one card](../../images/cards/cards-flow-single.png)
...
To keep the cards you supply secure, all card-related mutations that initiate a sensitive action require <Term id="consent">consent</Term>.
Review the list of all [sensitive operations that require consent](/users/reference/sensitive-operations) with Swan.
