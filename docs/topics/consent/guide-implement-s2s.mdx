---
title: Implement server-to-server consent
---

# Implement server-to-server consent
...
You can also use various libraries and packages to genearte keys that follow the cryptographic standards:

- https://git.coolaj86.com/coolaj86/eckles-cli.js
...
Then, **follow steps 1-3** to generate and install your new keys and consent with the new key pair.
