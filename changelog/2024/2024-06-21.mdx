...
🖊️ [Check returns](/payments/guides/merchants/in-person/checks/#r-transactions) now have a specific `returnReason`.
...
💥 Reminder: on **July 15**, the Ultimate Beneficial Owner's (UBO) residency country (`individualUltimateBeneficialOwners.residencyAddress.country`) becomes mandatory in our [onboarding API](/accounts/guides/onboarding/company/requirements#country-reqs).
