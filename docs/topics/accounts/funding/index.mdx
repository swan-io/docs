...
| `Rejected` | Payment mandate was rejected |
...
When using SEPA Direct Debit to fund your account, Swan reserves a percentage of your total transaction amount for three business days, after which the reserved amount is released to your account.
