...
- [Licence and regulatory status](/get-started/become-a-partner/licence-regulatory-status): Swan's e-money licence, your legal status, and restricted businesses.
- [ORIAS registration](/get-started/become-a-partner/orias-registration): required for France-based partners.
- [Rates and billing](/get-started/become-a-partner/rates-billing): how rates and fees work.
- [Brand and communication rules](/get-started/become-a-partner/brand-communication): how to present your offer.
...
![Image of three-party partnership](../../images/get-started/become-a-partner/three-party-model.png)
...
For example, Swan might check that you are [billing your users for compliant services](/accounts/concepts/billing/regulated-fees) only.
