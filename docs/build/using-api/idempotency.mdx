...
- [`initiateCreditTransfers`](/payments/guides/credit-transfers/sepa/initiate-ct/) to prevent duplicate payments.
- [`initiateMerchantPaymentCollection`](/payments/guides/merchants/online/idd/initiate/) to prevent duplicate Internal Direct Debit payment collections.
- [`initiateSepaDirectDebitMerchantPayment`](/payments/guides/merchants/online/sdd/initiate/) to prevent duplicate merchant payment collections.
- [`initiateFundingRequest`](/accounts/guides/funding/initiate-request) to prevent duplicate account funding requests.
...
- [Errors and rejections](/build/using-api/errors-rejections) · [Pagination](/build/using-api/pagination)
