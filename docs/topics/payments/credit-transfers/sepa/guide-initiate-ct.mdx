...
Starting October 9, 2025, Swan automatically includes [Verification of Payee (VoP)](/preview/verification-of-payee) in all SEPA Credit Transfers. For an optimal user experience, consider integrating the `verifyBeneficiary` mutation.
:::
