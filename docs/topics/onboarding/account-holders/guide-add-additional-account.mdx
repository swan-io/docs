...
1. [Run the `OnboardCompanyAccountHolder` mutation](../company/guide-create.mdx), using the same information as the account holder's existing Swan account.
...
1. [Run the `OnboardIndividualAccountHolder` mutation](../individual/guide-create.mdx), using the same information as the account holder's existing Swan account.
1. Finalize the onboarding with the new onboarding ID and the user access token.
The account holder doesn't need to do anything.
