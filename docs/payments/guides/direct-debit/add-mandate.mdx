...
When **Swan receives** [new SEPA Direct Debit instructions](/payments/concepts/direct-debit#received-instructions-new), the corresponding mandate is added **automatically**.
