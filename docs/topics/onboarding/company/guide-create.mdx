...
The previous [`onboardCompanyAccountHolder`](https://api-reference.swan.io/mutations/onboard-company-account-holder/) mutation is deprecated and will be removed in December 2026.
