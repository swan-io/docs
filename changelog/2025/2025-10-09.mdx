...
🔍 Starting **November 12th**, the [`onboarding(id: ID!)` query](https://api-reference.swan.io/queries/onboarding) may return `null` when no onboarding exists for the given ID, instead of always returning an [`Onboarding` object](https://api-reference.swan.io/objects/onboarding).
