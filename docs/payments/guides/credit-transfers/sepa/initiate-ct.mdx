...
Send a SEPA Credit Transfer with an optional structured or unstructured [invoice reference](/payments/concepts/credit-transfers/sepa#invoice-references) by using the `labelType` and `label` fields.
