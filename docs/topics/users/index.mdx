...
Using mobile phone numbers to identify users greatly simplifies their experience: users only need to know their mobile number to log into Swan, and occasionally their [chosen 6-digit passcode](./identifications/index.mdx#signup).
...
They shouldn't sign up with a new onboarding, which would create a new Swan user.
...
Users sign up for Swan during the [onboarding process](../onboarding/index.mdx).

Your user:

1. Opens their [onboarding link](../onboarding/index.mdx#links).
...
1. Confirms their mobile number, after which they **continue the signup process** on their mobile device. How they confirm this step depends on whether they opened the onboarding link from a computer or their mobile device:
...
1. Enters their **personal information**, including their name and birthdate. This information **much match** the information that appears on their **identity documents**.
...
1. Completes [**identification**](./identifications/index.mdx), where Swan verifies their identity. This step can be performed later, though it's recommended to complete it as soon as possible.
