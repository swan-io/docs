...
<SelfEmployedNote accountType="individual" />
...
|---|---|---|
| :fr: France<br/>*includes unregistered<br/>self-employed* | ✓ **PVID** | Expert + first transfer<br/>QES |
| :de: Germany<br/>*includes self-employed* | ✓ **QES + first transfer** | *none* |
...
|`employmentStatus`| ✓ Required | ✓ Required | ✓ Required |
|`language`| ✓ Required | ✓ Required | ✓ Required |
|`monthlyIncome`| ✓ Required | ✓ Required | ✓ Required |
|`redirectUrl`|  |  |  |
...
* [Create an individual onboarding link](./guide-create-onboarding.mdx)
* [Update an individual onboarding](./guide-update-onboarding.mdx)