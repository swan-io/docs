...
A check transaction might be rejected for the following reasons.
...
Merchants can **fix and resend rejected checks**.
To do this, the merchant should create a new `checkIn` transaction before sending the check to Swan's provider.
