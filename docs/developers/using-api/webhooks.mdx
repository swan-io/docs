...
| `DigitalCard.Updated` | Digital card [status](/topics/cards/digital/#statuses) (for example, `pending`, `enabled`, `declined`) changed during provisioning or wallet usage. |
