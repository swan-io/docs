...
Companies of all kinds can unlock the full potential of their product by embedding Swan's banking features such as [accounts](/accounts/concepts/account), [cards](/cards), and [payments](/payments).

Founded in 2019, Swan processes over 750 million euros of transactions per month for over 100 Partners, and operates across [30 European countries](/get-started/become-a-partner/country-coverage).
The company has received growth capital from leading VC investors such as Lakestar, Accel, Creandum, and Bpifrance.
Swan is a Mastercard principal member and a licensed financial institution, [regulated by the French banking authority](/get-started/become-a-partner/licence-regulatory-status#license) (ACPR).
...
1. **API Explorer**, **changelog**, and **search**: links to Swan's API Explorer and product changelog, plus the invaluable global search that unifies the API Reference with all product, partnership, and developer documentation. Swan's search is powered by Algolia.
