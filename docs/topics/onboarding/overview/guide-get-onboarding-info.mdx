...
Refer to the guides to update an [individual](../individual/guide-update-onboarding.mdx) or [company](../company/guide-update-onboarding.mdx) onboarding.
...
```graphql {5-8,10-13,14,16-18,20,23,26} showLineNumbers
...
```json {7-8,10,12-16,19-21,26,31-32,34,36-37,39,41,46-47,49,51-52,54,56,60} showLineNumbers
{
  "data": {
    "onboardings": {
      "edges": [
