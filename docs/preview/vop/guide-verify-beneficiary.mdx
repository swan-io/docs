...
```json title="Returned Payload" {5-6,9-10}
{
  "data": {
    "verifyBeneficiary": {
...
The `InitiateCreditTransfersSuccessPayload` includes the `beneficiaryVerificationResults`, an array of `VerifyBeneficiaryResult` objects ordered by result types.
