...
To minimize fraud risk, physical cards have limits on the maximum amount spent per single payment, and the total cumulative amount spent before your user must verify their identity. 
