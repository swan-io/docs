...
The following mutations concern sensitive operations.
Most require consent, though some may or may not require consent depending on the context (for example, `suspendAccountMembership`).
