...
|---|---|---|---|---|
| `RCVD` | Ongoing | Received | — | Default. No transaction is linked to the payment yet, consent is pending, and the internal `initiateCreditTransfers` request hasn't been made. |
...
## I validated my consent but don't see any transaction {#consent-no-transaction}
