...
Consent is built-in to Swan's offer, meaning you don't have to handle it yourself.
...
Note that consent requests **timeout 20 minutes after the first request** is made to the `consentUrl`.
