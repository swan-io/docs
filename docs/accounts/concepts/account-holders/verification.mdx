...
The verification process for a new <Term id="account-holder">account holder</Term> is thorough, and Swan provides a streamlined process through which each account holder proves they're who they claim to be.
...
1. [**Identification**](/users/concepts/identifications): User that opened the [individual](/accounts/guides/onboarding/individual/requirements#identification-recommendations) or [company](/accounts/guides/onboarding/company/requirements#identification-recommendations) account completes identification with an ID document and a picture or video.
