...
Account members whose membership status is `BindingUserError` can still access basic account and card information, but they can't perform any [sensitive operations](/users/concepts/consent#sensitive), such as making a transfer or viewing their card numbers.
