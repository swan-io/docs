...
| Dichiarazione delle imposte all'Agenzia delle Entrate | Individual tax return document | <ul><li>Retrieved by Swan if the VAT (Value-Added Tax) number is provided in the onboarding form.</li><li>If you don't provide the VAT number, Swan requests it directly from the end user.</li><li>Only the most recent tax return is accepted.</li></ul> |
