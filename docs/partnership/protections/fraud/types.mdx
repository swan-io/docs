...
- **Check links before you open them**. Fraudulent websites often use small URL changes to impersonate legitimate sites. [Double-check](../../../partnership/protections/fraud/#double-check) for typos's, extra characters, letters, or numbers in the link. 
