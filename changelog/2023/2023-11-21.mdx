...
By using `mode=InstantWithFallback`, your SEPA Instant Credit Transfers will ["fallback" to regular SEPA Credit Transfers](/payments/concepts/credit-transfers/sepa/#instant-fallback) if instant isn't available.
