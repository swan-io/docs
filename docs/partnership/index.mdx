...
In English, ACPR translates to _Prudential Supervision and Resolution Authority_.
...
For example, consent is _always_ required for [sensitive operations](../topics/users/consent/index.mdx#sensitive), and consent _always_ involves Swan in a Live environment.
...
This could include [Swan's user interfaces or your own custom integration](../topics/get-started/choose-integration.mdx).
...
For example, Swan might check that you are [billing your users for compliant services](../topics/accounts/billing/guide-compliant-billing.mdx) only.

### Swan and your users {#model-swan-users}

This direct relationship, meaning direct contact between Swan and your users, is used primarily during the [account holder verification](../topics/onboarding/account-holders/index.mdx#verifying-account-holders) and [Strong Customer Authentication](../topics/users/consent/index.mdx#sca) processes.
...
For these operations, either [you or Swan can charge the user](../topics/accounts/billing/guide-compliant-billing.mdx) depending on your marketing perspective.
...
To learn more about how Swan handles fees and your options to charge your users, refer to the guide to [build a compliant billing offer](../topics/accounts/billing/guide-compliant-billing.mdx).
:::
