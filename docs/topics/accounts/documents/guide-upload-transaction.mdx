...
This is only possible when using the API to initiate the transaction.
...
1. Add other optional messages to the payload, either for validation or in case of rejection (rejection not shown).
...
```json {10-11,14-15,18-19,22-23,26-27,30-31,34-35,38-39,42} showLineNumbers
{
  "data": {
    "generateTransactionSupportingDocumentUploadUrl": {
      ...
      "supportingDocumentCollectionId": "e9021128-c4dc-4546-b012-f4707217d196",
      "supportingDocumentId": "cc5a7444-f6cb-4274-9c4e-4027817bc8cb",
      "upload": {
        "fields": [
          {
            "key": "Key",
