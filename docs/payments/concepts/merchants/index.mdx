...
<p className="ia-lede">Account holders who accept payments by card (online and in person), direct debit, or French check, through payment links or invoices.</p>
...
Merchants are account holders who want to accept payments by card (online and in person), SEPA Direct Debit, Internal Direct Debit, or French checks. They can do this either through a payment link or an invoice.
...
import RollingReserve from '../../guides/merchants/partials/_rolling-reserve.mdx';
