...
However, Swan _can_ determine consent isn't required based on the context of the payment, in which case the payment is created with the status `Initiated`.
:::
