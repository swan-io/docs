...
related:
  ...
  - /payments/guides/overview/get-payment-info
---
...
Learn more about this query in the guide to [get payment information](/payments/guides/overview/get-payment-info).
