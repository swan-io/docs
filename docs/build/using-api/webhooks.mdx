...
| `eventType` | Trigger |
| --- | --- |
| `AccountSetting.Updated` | The [`allowBulkCreditTransfersWithoutBeneficiaryVerification` setting](/payments/guides/credit-transfers/sepa/update-vop-settings#parameters) changed. |
...
| `TransactionStatement.Generated` | [Transaction statement](/payments/concepts/transactions/statements) was generated successfully. | All payment types |
