...
Starting October 9, 2025, trusted beneficiaries require [Verification of Payee (VoP)](verification-of-payee) verification before each transfer per EU regulation. Learn about [VoP with saved beneficiaries](verification-of-payee#saved-beneficiaries).
:::
