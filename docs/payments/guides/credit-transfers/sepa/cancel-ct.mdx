...
If your <Term id="transactions">transaction</Term> has any other status, including `Pending`, you can request a [recall](/payments/concepts/credit-transfers/sepa#recalled).
:::
