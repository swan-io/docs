...
🔍 We've added [new filters](https://api-reference.swan.io/inputs/transactions-filters-input/) to enhance searching for [transaction information](/payments/guides/overview/get-transaction-info/) by **amount** and **execution date** in the **API**:
