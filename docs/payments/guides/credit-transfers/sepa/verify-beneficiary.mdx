...
This is [Option 2: Custom verification](/payments/concepts/verification-of-payee#option-2). For single transfers, Swan can run the check for you instead.
...
Server-to-Server consent works with [both VoP integration options](/payments/concepts/verification-of-payee#integration-flows).
:::
