...
Update the company name and residency address linked to a capital deposit case with the API.
...
- [Update shareholder amount](/accounts/guides/onboarding/capital-deposits/update-shareholder-amount) — change a shareholder's capital deposit amount on the case.
