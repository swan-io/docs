...
Consider the following actions you can take to strengthen your product and help you users avoid falling victim to fraud.
Share the corresponding [Support Center article](https://support.swan.io/hc/en-150/articles/25497259152157) with your users to help them reinforce their safety online.

#### (1) Don't respond urgently. {#urgency}
...
#### (2) Know what fraud looks like. {#educate}
...
Fraud often looks close the real thing, but not quite.
Any time a communication feels suspicious, evaluate it closely. Check for typos or errors in names, websites, email addresses, and messages. If you received a phone call, consider whether it sounded authentic.

#### (3) Double-check. {#double-check}

If a request feels suspicious, it nevers hurts to double-check.
Don't hesitate to contact the person or organization who sent the request through another communication channel.
For example, if you received a request by email, call the sender directly before doing anything.

If a suspicious email or text message includes a link, hover over the link to see if it looks legitimate.
You could also open a new tab or window and search for the website on your own instead of opening the link provided.

#### (4) Protect account information. {#protect-info}

You and your users have a lot of control around protecting your account information.

Consider making multi-factor authentication (MFA) or two-factor authentication (2FA) mandatory.
Activate it personally for any app you can.
...
Pairing password hygiene with MFA or 2FA keeps your information much safer.
...
Software providers regularly improve their built-in safety measures, so make sure to take the time to install updates.

Review Swan's [Changelog](/changelog/) regularly so your implementation remains secure.
