...
Swan automatically includes [Verification of Payee (VoP)](/payments/concepts/verification-of-payee) in all single SEPA Credit Transfers. For an optimal user experience, consider integrating the `verifyBeneficiary` mutation.
:::
...
For bulk credit transfers requiring Verification of Payee (VoP), you must use verification tokens from the `verifyBeneficiary` mutation. [Learn more about bulk credit transfers with VoP →](/payments/concepts/verification-of-payee/bulk-transfers)
:::
