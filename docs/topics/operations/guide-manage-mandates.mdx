...
| --- | --- | --- | --- |
| **Suspend** | Temporarily blocks future direct debits. Any pending instructions are rejected. | Yes, the mandate can be re-enabled later. | Through your product (if your development team has integrated it) or through a Swan Support request. |
...
Your development team can integrate the [suspend](https://docs.swan.io/topics/payments/direct-debit/guide-suspend-mandate/) and [enable](https://docs.swan.io/topics/payments/direct-debit/guide-enable-mandate/) mutations so your users can manage mandates directly from your product.
...
:::caution Creditor contact required
