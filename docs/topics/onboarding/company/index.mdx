...
For companies in 🇫🇷 France, Swan automatically prefills representative information from the national business registry when available.
...
Note that this section is broken up into company and account holder information, information about the UBO, information about the legal representative, and information about representatives.
...
#### Individual representative information {#country-reqs-individual-representatives}

:::note API usage
Use `representatives` with `type: Individual` for natural person representatives.
:::

| API field | 🇫🇷<br/>France | 🇩🇪<br/>Germany | 🇮🇹<br/>Italy | 🇳🇱<br/>Netherlands | 🇪🇸<br/>Spain |
|---|---|---|---|---|---|
|`representatives.type`| ✓ Required<br/>(`Individual`) | ✓ Required<br/>(`Individual`) | ✓ Required<br/>(`Individual`) | ✓ Required<br/>(`Individual`) | ✓ Required<br/>(`Individual`) |
...
#### Company representative information {#country-reqs-company-representatives}

:::note API usage
Use `representatives` with `type: Company` for legal entity representatives.
:::

| API field | 🇫🇷<br/>France | 🇩🇪<br/>Germany | 🇮🇹<br/>Italy | 🇳🇱<br/>Netherlands | 🇪🇸<br/>Spain |
|---|---|---|---|---|---|
|`representatives.type`| ✓ Required<br/>(`Company`) | ✓ Required<br/>(`Company`) | ✓ Required<br/>(`Company`) | ✓ Required<br/>(`Company`) | ✓ Required<br/>(`Company`) |
|`representatives.roles`| | | | | |
