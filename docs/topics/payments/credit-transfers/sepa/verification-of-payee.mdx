...
<Tabs>
  ...
  <TabItem value="not-possible" label="❌ Verification not possible">
    ...
    **End-user action**: Proceed without verification
  ...
  <div className="col col--6">
    <div className="card" style={{height: '100%', backgroundColor: '#fffbf0', border: '1px solid #ffeaa7'}}>
      ...
      <div className="card__body">
        ...
        <ul>
          <li>No development is required for single SEPA credit transfers..</li>
          <li>Swan displays VoP results in the consent screen.</li>
  ...
  <div className="col col--6">
    <div className="card" style={{height: '100%', backgroundColor: '#f0f9f0', border: '1px solid #d4edda'}}>
      ...
      <div className="card__body">
        ...
        <ul>
          <li>Complete control over the VoP UX.</li>
          <li>Custom error handling and user guidance.</li>
          <li>Best for: An enhanced UX and complex payment flows.</li>
        </ul>
      </div>
    </div>
  </div>
...
| **Standing Orders** | ✅ Supported | ✅ Supported | Required in the scheduling phase |
...
:::warning 
**Option 1 is not available for Bulk Credit Transfers**. For bulk credit transfers, use Option 2 or if you have company end-users, opt-out of VoP via the dedicated mutation.
:::
