...
* [French check payments](../merchants/in-person/checks/index.mdx) *(merchant offer only)*
...
- [International Credit Transfers](./credit-transfers/international/index.mdx) (incoming and outgoing)
...
After the statement is generated successfully with the API,  you receive a `TransactionStatement.Generated` [webhook notification](/dev-tools/using-api/webhooks#events-transactions).
...
- Transactions:
    ...
    - [Export transaction data](./overview/guide-export.mdx)