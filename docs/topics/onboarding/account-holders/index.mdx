...
Swan will reject an incoming transfer that would cause the balance to exceed €150.

#### Impact of fees on balance restrictions

Swan fees don't count toward the €150 limit. 
For example, if a user receives a €150 SEPA Credit Transfer and they're charged a €2 Swan fee, their balance will be €148. 
Since they received €150, the account reached it's lifetime limit. 
Swan will automatically reject additional incoming transfers.
