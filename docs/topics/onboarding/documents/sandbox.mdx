...
🔎 [Open the query in API Explorer](https://explorer.preprod.swan.io?query=%3D&tab=api)
...
🔎 [Open the query in API Explorer](https://explorer.swan.io?query=%3D%3D&tab=api)
...
With the supporting document collection ID, use the Event Simulator to change the [supporting document collection status](./about.mdx#collection-statuses) to any available status.
