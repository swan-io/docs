...
Download a PDF of an account's bank details for the main IBAN or virtual IBANs, with the API or from your Dashboard.

Download a PDF of your [bank details](/accounts/concepts/account#bank-details) for the account's main IBAN, a list of virtual IBANs, or specific virtual IBANs with the API.
...
1. Add [pagination](/dev-tools/using-api/pagination). The sample query returns the `first` 5 entries (line 3).
...
- [Export account data](/accounts/guides/account-operations/export)
- [Generate an account statement](/accounts/guides/account-operations/generate-statement)
