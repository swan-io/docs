...
1. **Swan sends email notifications** about account closure. Please review the section on [email communications](/accounts/concepts/closure#comms) for precise details.
...
1. After the account status changes to `Closed`, Swan **sends a final email** to the account holder informing them that their account is officially closed. You may or may not receive the email as well according to your [communication preferences](/accounts/concepts/closure#comms).

## Related

- [Account closure](/accounts/concepts/closure) — closure processes, reason codes, and communications.
- [Close a limited account](/accounts/guides/closure/close-limited)
