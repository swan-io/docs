...
Add a <Term id="trusted-beneficiary">trusted beneficiary</Term> with the API for <Term id="credit-transfer">International Credit Transfers</Term>.

## Add a trusted beneficiary {#guide-add}

:::tip Prerequisites
Get the list of required key/value pairs for your [**beneficiary**](/payments/guides/credit-transfers/international/get-beneficiary-forms).
...
<a href="https://explorer.swan.io?query=%3D&tab=api" className="explorer-badge">Open in API Explorer</a>
...
```graphql {4,5-17,19,20,22-24,41} showLineNumbers
