...
You can also change the documents you already uploaded as long as the [document status](/accounts/guides/onboarding/capital-deposits/#documents-statuses) remains `Uploaded`.
