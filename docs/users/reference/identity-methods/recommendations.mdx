...
Accepted <Term id="identification">identification</Term> processes vary by country based on local regulations.
...
Refer to the following table for accepted and recommended identification processes for individual and company accounts.
The first process listed, in bold, is the process Swan recommends.
...
| 🇧🇪 Belgium ∗ | **QES**<br />Expert + first transfer | **Expert**<br />QES<br />PVID |
