...
| Justificatif de domicile des bénéficiaires effectifs | Proof of address of UBOs | <ul><li>Must be dated within the last 3 months.</li></ul> |
| Formulaire Personne Politiquement Exposée (PPE) | Politically Exposed Person (PEP) form | <ul><li>Will be sent to the user (based on your communication preferences).</li><li>Must be dated and signed.</li></ul> |
...
| Formulaire Personne Politiquement Exposée (PPE) | Politically Exposed Person (PEP) form | <ul><li>Will be sent to the user (based on your communication preferences).</li><li>Must be signed and dated.</li></ul> |
...
| Document type (French) | Description | Details |
|---|---|---|
| Preuve d'enregistrement* | Proof of registration* | <ul><li>Announcement in the Journal Officiel (JOAFE).</li><li>Requested for associations from **Alsace** or **Moselle**.</li></ul> |
| Statuts de l'association | Articles of Association | <ul><li>Must be dated and signed.</li><li>Must be the most recently published version.</li><li>If amendments have been made, it must be dated within the last **6 months**.</li></ul> |
| Procès-verbal de la dernière assemblée générale* | Latest general meeting minutes* | <ul><li>Meeting minutes must be the most recent within the last 2 years.</li></ul> |
...
| Justificatif de l'adresse de l'association | Proof of association address | <ul><li>Must be dated within the last 3 months.</li></ul> |
| Justificatif de situation financière / origine des fonds | Evidence of the association's funds | <ul><li>Must be the most recent version, and can include annual accounts, bank statements, and tax returns.</li></ul> |
| Procuration et pièce d'identité du représentant légal | Power of attorney and identity document of the legal representative (if not the account holder) | <ul><li>Must be dated within the last year.</li></ul> |
| Structure de gouvernance / Organigramme | Governance structure documentation | <ul><li>Required when the association's governance structure is complex or not clear from other documents.</li><li>Provided by the account holder.</li></ul> |
| Liste des membres / Règlement d'admission | Membership list / admission rules | <ul><li>Provided by the account holder.</li></ul> |
| Déclaration des bénéficiaires effectifs / Déclaration de contrôle effectif | UBO declaration  | <ul><li>For example:<ul><li>Copie intégrale des informations déclarées</li><li>Déclaration Relative au(x) Bénéficiaire(s) Effectif(s) d'une Société</li><li>Document Relatif au Bénéficiaire Effectif</li></ul></li><li>Must be an official document, dated, signed, and stamped.</li><li>Provided by the account holder.</li></ul> |
| Décret de reconnaissance d'utilité publique | Declaration recognizing public utility status | <ul><li>Must be dated within the last 3 months.</li><li>Provided by the account holder.</li></ul> |
| Formulaire Personne Politiquement Exposée (PPE) | Politically Exposed Person (PEP) form | <ul><li>Will be sent to the user by Swan (based on your communication preferences).</li><li>Must be signed and dated.</li></ul> |
| Déclaration sur l'honneur / auto-déclaration signée | Sworn statement | <ul><li>Must be dated within the last 3 months.</li><li>Provided by the account holder.</li></ul> |
...
| Formulaire Personne Politiquement Exposée (PPE) | Politically Exposed Person (PEP) form | <ul><li>Will be sent to the user</li><li>Must be dated and signed.</li></ul> |
