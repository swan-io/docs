...
| Spending limits | Standard | Higher | Highest |
...
Swan offers different insurance levels to protect cardholders, providing them extra protection.
Insurance is configured through the selected **card package**. When you choose a package during Card Product creation, the corresponding coverage is automatically enabled for all cards issued under that Card Product.

Learn more about card insurance in the [card insurance section](https://www.google.com/search?q=/preview/card-insurance).
