...
To protect the user and comply with legal requirements, users can only provide consent through [Strong Customer Authentication](/users/concepts/consent/sca) (SCA), a multi-factor authentication requirement for payment service providers; the SCA page also covers the consent user experience and sequence diagrams.
