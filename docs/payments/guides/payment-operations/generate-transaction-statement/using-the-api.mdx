...
audience:
  - dev
counterpart: /payments/guides/payment-operations/generate-transaction-statement/from-the-dashboard
related:
  - /payments/guides/payment-operations/generate-transaction-statement
  - /payments/guides/payment-operations/generate-transaction-statement/from-the-dashboard
  - /payments/concepts/transactions/statuses
---

# Generate a transaction statement using the API

Generate a transaction confirmation statement with the API, then retrieve its download URL.
