...
1. Swan exposes two APIs:
    ...
    - Use the [**Testing API**](/dev-tools/tools/testing-api) in partnership with the [**Event Simulator**](/dev-tools/tools/event-simulator) to simulate events that must include other people, such as consent and authentications.

**Open the menu to switch** between tokens and projects by clicking around your logo or user type:

2. Switch between [**access tokens**](/dev-tools/using-api/authentication#tokens):
...
- [Testing the API](/dev-tools/tools/testing-api) · [Event simulator](/dev-tools/tools/event-simulator) · [Test tools guide](/dev-tools/tools/test-tools-guide)
