...
Use the `transactions` query to [get information about transactions](/payments/guides/overview/get-transaction-info), adding `returnReason` to `... on SEPACreditTransferTransaction`.
