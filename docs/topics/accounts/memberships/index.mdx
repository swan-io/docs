...
When an account member's membership is disabled, their recurring SingleUseVirtualCards are automatically reassigned to the account's Legal Representative. The cards remain active and functional after reassignment to ensure business continuity.

This reassignment only affects recurring SingleUseVirtualCards; other card types may have different behaviors.

[Learn more about recurring SingleUseVirtualCards](/topics/cards/virtual/#suv-recurring)
