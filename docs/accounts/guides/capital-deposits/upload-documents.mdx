...
You can also change the documents you already uploaded as long as the [document status](/accounts/reference/capital-deposits#documents-statuses) remains `Uploaded`.
