...
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(52877);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(77990);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(69538);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(93201);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(49349);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(53274);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(25580);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(84873);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(96300);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(34800);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(42266);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(92767);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(24196);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(81294);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(88081);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(5311);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(24635);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(97359);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(16918);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(84275);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(28087);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(15394);
...
const specifiedSDLRules = [
  graphql__WEBPACK_IMPORTED_MODULE_5__/* .LoneSchemaDefinitionRule */ .t,
  graphql__WEBPACK_IMPORTED_MODULE_6__/* .UniqueOperationTypesRule */ .q,
  graphql__WEBPACK_IMPORTED_MODULE_7__/* .UniqueTypeNamesRule */ .P,
  graphql__WEBPACK_IMPORTED_MODULE_8__/* .UniqueEnumValueNamesRule */ .L,
  graphql__WEBPACK_IMPORTED_MODULE_9__/* .UniqueFieldDefinitionNamesRule */ .y,
  graphql__WEBPACK_IMPORTED_MODULE_10__/* .UniqueDirectiveNamesRule */ .o,
  graphql__WEBPACK_IMPORTED_MODULE_11__/* .KnownTypeNamesRule */ .I,
  graphql__WEBPACK_IMPORTED_MODULE_12__/* .KnownDirectivesRule */ .J,
  graphql__WEBPACK_IMPORTED_MODULE_13__/* .UniqueDirectivesPerLocationRule */ .k,
  graphql__WEBPACK_IMPORTED_MODULE_14__/* .PossibleTypeExtensionsRule */ .g,
  graphql__WEBPACK_IMPORTED_MODULE_15__/* .UniqueArgumentNamesRule */ .L,
  graphql__WEBPACK_IMPORTED_MODULE_16__/* .UniqueInputFieldNamesRule */ .P
];
function validateWithCustomRules(schema, ast, customRules, isRelayCompatMode, isSchemaDocument) {
  const rules = graphql__WEBPACK_IMPORTED_MODULE_17__/* .specifiedRules.filter */ .i.filter((rule) => {
    if (rule === graphql__WEBPACK_IMPORTED_MODULE_18__/* .NoUnusedFragmentsRule */ .J || rule === graphql__WEBPACK_IMPORTED_MODULE_19__/* .ExecutableDefinitionsRule */ .i) {
      return false;
    }
    if (isRelayCompatMode && rule === graphql__WEBPACK_IMPORTED_MODULE_20__/* .KnownFragmentNamesRule */ .a) {
      return false;
    }
    return true;
  });
  ...
  const errors = (0,graphql__WEBPACK_IMPORTED_MODULE_21__/* .validate */ .Gu)(schema, ast, rules);
  return errors.filter((error) => {
    if (error.message.includes("Unknown directive") && error.nodes) {
      const node = error.nodes[0];
      if (node && node.kind === graphql__WEBPACK_IMPORTED_MODULE_22__/* .Kind.DIRECTIVE */ .h.DIRECTIVE) {
...
function getDiagnostics(query, schema = null, customRules, isRelayCompatMode, externalFragments) {
  ...
  if (externalFragments) {
    fragments = typeof externalFragments === "string" ? externalFragments : externalFragments.reduce((acc, node) => acc + (0,graphql__WEBPACK_IMPORTED_MODULE_23__/* .print */ .S)(node) + "\n\n", "");
  }
  const enhancedQuery = fragments ? `${query}

${fragments}` : query;
  try {
    ast = (0,graphql__WEBPACK_IMPORTED_MODULE_24__/* .parse */ .Qc)(enhancedQuery);
  } catch (error) {
    if (error instanceof graphql__WEBPACK_IMPORTED_MODULE_25__/* .GraphQLError */ .__) {
...
function validateQuery(ast, schema = null, customRules, isRelayCompatMode) {
  ...
  const deprecationWarningAnnotations = (0,graphql__WEBPACK_IMPORTED_MODULE_21__/* .validate */ .Gu)(schema, ast, [
    graphql__WEBPACK_IMPORTED_MODULE_26__/* .NoDeprecatedCustomRule */ .r
