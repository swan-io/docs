...
Each package includes a predefined set of features and settings tailored to specific spending needs. 
This allows you to quickly launch market-ready offers without building everything from scratch.
Some features are only available as part of a card package.
...
Insurance is configured through the selected **card package** and the coverage corresponds with the card package level. 
...
1. Individual cardholders and companies might impose spending limits over a rolling period to protect their funds when issuing cards to other people.
    - A company might impose a €100 spending limit over 7 days rolling for travel expenses.
...
| Card payment | Individual **cardholder*** | €5000 per card |
| ATM withdrawal | Company **account** holder | €3000 total |
| ATM withdrawal | Individual **account** holder | €1500 total |

**Note: Users' card payment spending limits may increase depending on their card package.* 

Consider the following examples:

- Company cardholder card transaction:
    - One of your **company cardholders** has five company cards.
    - They can spend a maximum of €50 000 between the five cards during a 30-day period.
...
- Individual account holder ATM withdrawal:
    ...
    - They can withdraw a maximum of €1500 total between the two cards during a 30-day period.
    - They **can't withdraw** a total of €3000—the maximum is per account holder.
    - The €1500 also counts toward their **card** transaction maximum of €5000 per card.
