...
Transaction statements, also called transaction confirmations, are [a different document: they demonstrate that Swan executed a specific transaction](/payments/concepts/transactions/statements), not the account's activity over a period.
