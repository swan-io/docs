...
Therefore, test this feature thoroughly [using the tools](/dev-tools) available to you.

:::info Card payments section
Refer to the [card payments section](/topics/payments/cards/) for more information about card transaction authorization and clearing.
:::

## General recommendations {#recommendations}

1. **Respond quickly**. In the [Live environment](/dev-tools#environments), authorizations time out after **1.5 seconds**.
...
The [**primary capture types**](/topics/payments/cards/#capture-types) you might encounter at Swan are explained in the card payments section.
...
- [Webhooks](/dev-tools/using-api/webhooks) · [Authentication](/dev-tools/using-api/authentication)
