...
| [`addCards`](https://api-reference.swan.io/mutations/add-cards/) | Add up to 250 total cards with the same API call. You can:<br /><br /><ul><li>Add virtual cards for multiple account members.</li><li>Add virtual cards and physical cards for multiple account members.</li><li>Add one virtual card and one physical card for one account member.</li><li>Add only virtual cards for some account members, and add both a virtual and a physical card for other account members.</li></ul> | [Print a physical card when adding a virtual card](./guide-print.mdx#print-with-virtual) |
