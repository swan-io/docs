...
📖 [Identify which user initiated a credit transfer](/payments/guides/credit-transfers/sepa/initiate-ct/#identify-initiator) by querying the payment before consent is granted, or by storing user details at the time of initiation.
