...
**Configuration**: This notification is always sent by Swan. The recipient is the email address provided during the onboarding flow by the account's legal representative, and the language used is the one selected during the onboarding flow. You can view its configuration in your **Dashboard** under **Settings** > **Notifications**. For compliance reasons, it can't be deactivated or edited.
