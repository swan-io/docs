...
Note that you also receive a funding source ID (line 6) and a <Term id="payment-mandate">payment mandate</Term> ID (line 9).
...
![Sample SEPA Direct Debit B2B payment mandate to provide to non-Swan account provider](../../../images/accounts/funding-mandate.png)
