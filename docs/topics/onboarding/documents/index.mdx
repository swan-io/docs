...
Consider these steps, including the statuses of both account holder verification and the supporting document collection.
...
<table>
  ...
  <tr>
    <td colspan="3">*Consider subscribing to the `supportingDocumentCollection.updated` [webhook](../../../developers/using-api/webhooks.mdx) to get notified that a request was sent to collect documents.*</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3">*If needed, [get a list of required supporting documents](./guide-get-list.mdx). Then, [upload missing documents](./guide-upload.mdx).*</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Supporting documents **accepted**</td>
    <td><center>`Pending`</center></td>
    <td><center>`PendingReview`</center></td>
  </tr>
  <tr>
    <td rowspan="2"><center>7b</center></td>
    <td>Supporting documents **rejected**</td>
    <td><center>`WaitingForInformation`</center></td>
    <td><center>`WaitingForDocuments`</center></td>
  </tr>
  <tr>
    <td colspan="3">*[Get the list of required supporting documents](./guide-get-list.mdx) and review the rejection reason. Then, return to step 4.*</td>
  </tr>
</table>
