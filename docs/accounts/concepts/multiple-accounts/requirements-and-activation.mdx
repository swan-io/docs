...
See [Multiple accounts requirements](/accounts/reference/accounts/multiple-accounts-requirements) for the legal representative and account holder criteria that must be met.
