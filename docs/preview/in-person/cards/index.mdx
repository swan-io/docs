...
## In-person card merchant payments {#merchant-card-payments}

In-person card merchant payments include **one or more transactions**.
...
> By clicking "Next", you accept the Swan Terms and Conditions and the [PARTNER NAME]'s partnership conditions.
