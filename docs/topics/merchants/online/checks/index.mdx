...
Merchants can accept payments using French checks if the debtor's bank is located in **mainland France** and the following **territories**: Guadeloupe, Guyane, Martinique, Mayotte, La Réunion, Saint Martin, and Saint Barthélémy. 
Nouvelle Calédonie, Polynésie Française, and Wallis and Futuna aren't currently supported.
