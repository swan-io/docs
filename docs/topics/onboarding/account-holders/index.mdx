...
These restrictions primarily affect the first incoming transfer made while the account holder is completing verification.
During this phase, the account remains in `Limited` status, and any first transfer exceeding the limits is automatically rejected.
