...
Shops, health professionals, home care providers, taxi drivers, and contractors all need to accept card payments on the go.
...
Swan suggests using this object in your integration to help merchants match orders, invoices, and sales to the right payment.
...
| `RejectedByCardAcquirer` | The payment was declined by the acquirer due to fraud or risk rules. | Present as a generic decline. Don't share details with the customer. |
