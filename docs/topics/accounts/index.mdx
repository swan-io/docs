...
Reasons are available for accounts suspended from 21 September 2026.
For accounts suspended before this date, the API returns an empty `suspensionReasons` list.
