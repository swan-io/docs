...
| `Processing`| The insurance subscription request is sent to the insurance provider for adhesion. |
...
sequenceDiagram
    ...
    Swan->>Insurance provider: Sends POST request to create insurance subscription
    Insurance provider-->>Swan: Confirms subscription
