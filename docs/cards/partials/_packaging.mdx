...
| Colorful paper insert | Paper used for the letter can be a color other than the standard white (additional cost) |
| Customized packaging | Use a box or flyer; can add additional time (additional cost) |

![Image of standard physical card packaging](../../images/cards/physical-card-letter.png)