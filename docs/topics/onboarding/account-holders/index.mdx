...
Account verification is an ongoing regulatory requirement rather than a one-time onboarding event. 
...
Account verification is an ongoing regulatory requirement rather than a one-time onboarding event. 
To comply with ACPR standards, Swan must periodically validate the information we have for every account holder.
...
Failure to complete the re-verification process within the 90-day window will result in the automatic suspension of the account. All associated IBANs, cards, and payment capabilities will be restricted until the verification is validated.
:::

### The re-verification portal
...
You are responsible for ensuring your branding assets (logo, colors) are up-to-date in the **Dashboard** > **Settings** to provide a seamless user experience.

The re-verification lifecycle follows a structured path from notification to validation:


### Re-verification timeline and reminders

The periodic re-verification process has a strict **90-day window**. The countdown begins the moment the initial notification is triggered.

| Milestone | Timeline | Communication Content |
| :--- | :--- | :--- |
| **Start of Re-KYC** | **Day 0** | **Initial notification:** First outreach sent to the legal representative (account admin) by email containing the unique portal link. |
| **First reminder** | **Month 1** | **Follow-up:** Sent 30 days after the initial request if the portal flow has not been finalized. |
| **Second reminder** | **Month 2** | **Follow-up:** Sent 60 days after the initial request to urge completion. |
| **Final warning** | **Last Week** | **Warning:** Sent approximately 7 days before the deadline to prevent immediate service restriction. |
| **Re-verification deadline** | **Day 90+** | **Account suspension:** Automatic restriction of all payment capabilities (SCT, SDD, and Card payments). |
