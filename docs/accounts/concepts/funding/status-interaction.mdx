...
Account funding involves three distinct statuses: [funding sources](/accounts/concepts/funding/statuses#funding-source-statuses), [payment mandates](/accounts/concepts/funding/statuses#mandates-statuses), and [account verification](/accounts/concepts/funding/statuses#account-verification-statuses).
