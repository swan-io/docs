...
### [Merchant payment method](/payments/concepts/merchants/payment-methods) {#merchant-payment-method}
...
Several Swan features may require payment mandates, including [account funding](/accounts/concepts/funding/payment-mandates), [accepting payments](/payments/concepts/merchants/mandates), and [received payment mandates for SEPA Direct Debit](/payments/concepts/direct-debit/received-mandates).
