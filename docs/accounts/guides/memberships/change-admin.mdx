...
- [Account memberships](/accounts/concepts/memberships) — model, statuses, and the account administrator concept.
- [Disable a membership](/accounts/guides/memberships/disable) · [Update a membership](/accounts/guides/memberships/update) — adjust the previous administrator's access.
- [Resend membership invitation notification](/accounts/guides/memberships/resend-invitation) — if the new administrator's invitation doesn't arrive.
