...
flowchart TD
    ...
    PIR --> WAI{Additional info<br/>needed?}
    WAI -->|No| WNSC
    WAI -->|Yes| WFAI[WaitingForAdditionalInformation]
    WFAI --> PIR
    
    WNSC[WaitingForNotaryShareDepositCertificate<br/><em>Notary reviews</em>]
...
| `Canceled` | The case was canceled before completion by Swan or the partner. |
