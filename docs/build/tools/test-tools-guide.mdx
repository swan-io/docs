...
![Image of Event Simulator SEPA Credit Transfers section](../../images/build/tools/test-add-1.png)

3. Choose whether to activate auto consent for your new Sandbox user.
1. Enter your Sandbox user's information.
1. Click **Save**.

![Image of Event Simulator SEPA Credit Transfers section](../../images/build/tools/test-add-2.png)
...
![Image of Sandbox users with user ID called out](../../images/build/tools/test-validate-1.png)

2. Go to **Dashboard** > **Developers** > **Event Simulator**
1. Open **Sandbox identifications**.

![Screenshot of the Dashboard Event Simulator with the Sandbox identifications section called out](../../images/build/tools/test-validate-2.png)
...
![Screenshot of the Event Simulator Sandbox identifications form with a successful simulation result](../../images/build/tools/test-validate-3.png)
...
![Image of Dashboard Event Simulator page](../../images/build/tools/test-simulator-return-1.png)
...
![Image of Event Simulator SEPA Credit Transfers section](../../images/build/tools/test-simulator-return-2.png)

## Related

- [Sandbox users](/build/tools/sandbox-users) · [Event simulator](/build/tools/event-simulator) · [Testing the API](/build/tools/testing-api)
