...
| Formulaire Personne Politiquement Exposée (PPE) | <Term id="pep">Politically Exposed Person</Term> (PEP) form | <ul><li>Swan sends this form to the end user (based on your communication preferences).</li><li>Must be dated and signed.</li></ul> |
| États financiers de l'organisation or Liasse Fiscale | Proof of company income | <ul><li>Must be the most recent.</li></ul> |
...
| Premier transfert* | First transfer* | <ul><li> For self-employed (entrepreneur individuel) individuals only.</li><li>Must make a first transfer into their payment account from another bank account registered in their name.</li><li>Bank account must be within the European Economic Area (EEA). </li></ul> |
...
| Formulaire Personne Politiquement Exposée (PPE) | Politically Exposed Person (PEP) form | <ul><li>Swan sends this form to the end user (based on your communication preferences).</li><li>Must be signed and dated.</li></ul> |
...
| Procuration signée par le représentant légal et Pièce d'identité du représentant légal | Power of attorney and identity document of the legal representative (if not the account holder) | <ul><li>Must be dated within the last year.</li></ul> |
...
| Pièce d'identité du représentant légal ou le président* | Identity document of the legal representative or the president* | <ul><li>Must be a valid identity document.</li><li>Swan uses it to verify authority.</li></ul> |
...
| Formulaire Personne Politiquement Exposée (PPE) | Politically Exposed Person (PEP) form | <ul><li>Swan sends this form to the end user.</li><li>Must be dated and signed.</li></ul> |
