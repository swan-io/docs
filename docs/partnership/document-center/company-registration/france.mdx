...
| Justificatif de situation financiers / origine des fonds| Evidence of company's funds | <ul><li>Must be the most recent version, and can include annual accounts, bank statements, and tax return.</li></ul> |
| Procuration et pièce d’identité du représentant légal | Power of attorney & identity document of the legal representative (if not the account holder) | <ul><li>Must be dated within the last year.</li></ul> |
...
| Déclaration sur l’honneur / auto-déclaration signée | Declaration of honor | <ul><li>Must be dated within the last 3 months.</li><li>Provided by the account holder.</li></ul> |
