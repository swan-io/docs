...
🤖 Swan's new [MCP (Model Context Protocol) servers](/dev-tools/tools/mcp-servers) give AI assistants direct access to Swan's GraphQL schema and documentation. Use them with Claude Desktop, Claude Code, or Cursor to generate accurate queries and get answers about the API.
...
- **[Account onboarding](/accounts/guides/onboarding/#notifications)**: Your account terms and conditions.
- **[Account holder verification](/accounts/guides/onboarding/account-holders#notifications)**: First transfer, Request supporting documents, Request supporting documents reminders, Your account is opened.
