...
:::warning Shipping costs depend on:
- Destination
- Delivery type (group or non-group, tracked or untracked)

International shipments may incur additional fees.
Shipping costs depend on the destination and delivery type. International shipments may incur additional fees. Delivery types, such as group or non-group, tracked or untracked, can also affect the cost.
:::
