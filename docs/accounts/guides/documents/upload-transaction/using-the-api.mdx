...
audience:
  - dev
counterpart: /accounts/guides/documents/upload-transaction/from-the-dashboard
related:
  - /accounts/guides/documents/upload-transaction
  - /accounts/guides/documents/upload-transaction/from-the-dashboard
  - /accounts/concepts/documents
  - /accounts/guides/documents/get-info
---

# Upload a transaction document using the API

Share <Term id="supporting-documents">supporting documents</Term> for transactions proactively with the API.
...
- [Initiate SEPA Credit Transfers](/payments/guides/credit-transfers/sepa/initiate-ct)
- [Initiate International Credit Transfers](/payments/guides/credit-transfers/international/initiate)
...
import UploadRecoverUrl from '../partials/_upload-recover-url.mdx';
...
import UploadPostRequest from '../partials/_upload-post-request.mdx';
...
If you'd like to confirm, query either the supporting document collection or the transaction.

### Query the collection {#confirm-collection}

<a href="https://explorer.swan.io?query=&tab=api" className="explorer-badge">Open in API Explorer</a>

```graphql showLineNumbers
query ConfirmUpload {
  supportingDocumentCollection(id: "$COLLECTION_ID") {
    id
    transaction {
      id
    }
...
### Query the transaction {#confirm-transaction}

<a href="https://explorer.swan.io?query=%3D%3D&tab=api" className="explorer-badge">Open in API Explorer</a>
