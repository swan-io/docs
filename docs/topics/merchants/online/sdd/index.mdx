...
For security and risk management, Swan may apply a **payment amount limit** to single SEPA Direct Debit (SDD). 
This limit defines the maximum amount a user can spend in a single SDD transaction. 
