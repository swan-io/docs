...
📃 [Upload supporting documents](/topics/accounts/documents/guide-upload-onboarding) using the `generateSupportingDocumentUploadUrl` mutation during the onboarding. This way you don't have to ask users a second time by email.
