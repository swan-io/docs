...
Documents might be required to support [account holder verification](/accounts/guides/onboarding/account-holders#verification-process), [verification renewal (Re-KYC)](/accounts/guides/onboarding/account-holders#verification-renewal), or to prove the validity of a transaction.
...
:::info Onboarding tip
For a better user experience, always include a [list of required documents](/accounts/guides/onboarding/#get-list) in your onboarding flows.
:::
...
You can also [query the API](/accounts/guides/documents/get-info).
...
- [Upload an onboarding document](/accounts/guides/documents/upload-onboarding)
- [Upload a transaction document](/accounts/guides/documents/upload-transaction)
- [Get information about a collection or document](/accounts/guides/documents/get-info)
- [Request a collection review](/accounts/guides/documents/request-collection-review)
- [Delete a document](/accounts/guides/documents/delete)
- [Sandbox: documents](/accounts/reference/sandbox-documents)
