...
module.exports = [
  ...
  // DOC-1834 — Sandbox simulation pages reclassified from Reference to Guides
  // (they're task pages; convention decision recorded on the epic).
  { from: "/accounts/reference/sandbox", to: "/accounts/guides/sandbox" },
  { from: "/accounts/reference/sandbox/sandbox-billing", to: "/accounts/guides/sandbox/billing" },
  { from: "/accounts/reference/sandbox/sandbox-documents", to: "/accounts/guides/sandbox/documents" },
  { from: "/accounts/reference/sandbox/sandbox-funding", to: "/accounts/guides/sandbox/funding" },
  { from: "/cards/reference/sandbox-physical", to: "/cards/guides/sandbox-physical" },
  { from: "/cards/reference/sandbox-digital", to: "/cards/guides/sandbox-digital" },
  { from: "/payments/reference/sandbox", to: "/payments/guides/sandbox" },
  { from: "/payments/reference/sandbox/sandbox-sepa", to: "/payments/guides/sandbox/sepa" },
  { from: "/payments/reference/sandbox/sandbox-direct-debit", to: "/payments/guides/sandbox/direct-debit" },
  { from: "/payments/reference/sandbox/sandbox-international", to: "/payments/guides/sandbox/international" },
  { from: "/payments/reference/sandbox/sandbox-cards", to: "/payments/guides/sandbox/cards" },
  { from: "/payments/reference/sandbox/sandbox-merchants", to: "/payments/guides/sandbox/merchants" },
  { from: "/payments/reference/sandbox/sandbox-merchant-online-cards", to: "/payments/guides/sandbox/merchant-online-cards" },
  { from: "/payments/reference/sandbox/sandbox-merchant-sdd", to: "/payments/guides/sandbox/merchant-sdd" },
  { from: "/payments/reference/sandbox/sandbox-merchant-idd", to: "/payments/guides/sandbox/merchant-idd" },
  ...
  },
  {
    ...
    to: "/payments/guides/sandbox/international",
  },
  {
  ...
  { from: "/topics/cards/physical/sandbox", to: "/cards/guides/sandbox-physical" },
  ...
  { from: "/topics/cards/digital/sandbox", to: "/cards/guides/sandbox-digital" },
  {
  ...
  },
  {
    ...
    to: '/payments/guides/sandbox/merchant-in-person-cards',
  },
  ...
  },
  {
    ...
    to: '/payments/guides/sandbox/merchant-checks',
  },
  {
  ...
  { from: "/accounts/reference/sandbox-billing", to: "/accounts/guides/sandbox/billing" },
  { from: "/accounts/reference/sandbox-documents", to: "/accounts/guides/sandbox/documents" },
  { from: "/accounts/reference/sandbox-funding", to: "/accounts/guides/sandbox/funding" },
  // DOC-1814 — Payments + Merchants migrated into the IA shell
  { from: "/topics/payments", to: "/payments/" },
  { from: "/topics/payments/overview/guide-get-payment-info", to: "/payments/guides/payment-operations/get-payment-info" },
  { from: "/topics/payments/overview/guide-get-payment-id", to: "/payments/guides/payment-operations/get-payment-id" },
  { from: "/topics/payments/overview/guide-get-transaction-info", to: "/payments/guides/payment-operations/get-transaction-info" },
  { from: "/topics/payments/overview/guide-get-transaction-id", to: "/payments/guides/payment-operations/get-transaction-id" },
  { from: "/topics/payments/overview/guide-get-transaction-list", to: "/payments/guides/payment-operations/get-transaction-list" },
  { from: "/topics/payments/overview/guide-generate-transaction-statement", to: "/payments/guides/payment-operations/generate-transaction-statement" },
  { from: "/topics/payments/overview/guide-export", to: "/payments/guides/payment-operations/export" },
  ...
  { from: "/topics/payments/cards/sandbox", to: "/payments/guides/sandbox/cards" },
  ...
  { from: "/topics/payments/credit-transfers/sepa/sandbox", to: "/payments/guides/sandbox/sepa" },
  ...
  { from: "/topics/payments/credit-transfers/international/sandbox", to: "/payments/guides/sandbox/international" },
  ...
  { from: "/topics/payments/direct-debit/sandbox", to: "/payments/guides/sandbox/direct-debit" },
  ...
  { from: "/topics/merchants/sandbox", to: "/payments/guides/sandbox/merchants" },
  ...
  { from: "/topics/merchants/in-person/checks/sandbox", to: "/payments/guides/sandbox/merchant-checks" },
  ...
  { from: "/topics/users/identifications/guide-get-identifications", to: "/users/guides/user-operations/get-info/identifications" },
  { from: "/topics/users/identifications/guide-get-latest-id", to: "/users/guides/user-operations/get-info/latest-identification" },
  { from: "/topics/users/identifications/sandbox", to: "/users/guides/sandbox-identifications" },
  { from: "/topics/users/overview/guide-deactivate", to: "/users/guides/user-operations/deactivate" },
  { from: "/topics/users/overview/guide-export", to: "/users/guides/user-operations/export" },
  { from: "/topics/users/overview/guide-get-info-one", to: "/users/guides/user-operations/get-info/one-user" },
  { from: "/topics/users/overview/guide-get-info-multiple", to: "/users/guides/user-operations/get-info/multiple-users" },
  { from: "/topics/users/overview/guide-get-list", to: "/users/guides/user-operations/get-info/user-list" },
