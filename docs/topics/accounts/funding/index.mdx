...
Only the full amount can be canceled. Transactions can only be canceled before they are sent to the SEPA payment gateway, respecting the current cutoff time. This is around **10:00 Central European [Summer] Time (CET/CEST)**.
