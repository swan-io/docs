...
1. Add all objects you need to review (for example `SupportingDocumentStatusInfo`) (lines 16-19).
...
Swan requires a document that's categorized as `Other` (line 15). 
`purposeDetails` is `Signed service agreement covering the billed period referenced in the payment` (line 16).
        ...
        "edges": [
          {
            "node": {
              ...
              "requiredSupportingDocumentPurposes": [
                {
                  "name": "Other",
                  "purposeDetails": "Signed service agreement covering the billed period referenced in the payment"
                }
              ],
              "supportingDocuments": [
                {
...
In this example, the required `CompanyRegistration` (line 8) document was received, reviewed, and `Validated` (line 18).
        ...
        "supportingDocuments": [
          {
            ...
            "updatedAt": "2026-04-14T15:15:21.161Z",
            "statusInfo": {
              "status": "Validated"
            }
          }
...
In this example, the required `UBODeclaration` (line 8) document was `Refused` (line 18) because it was an `InvalidDocument` (line 22).
`purposeDetails` is `null` here because this is a standard purpose (line 9).
