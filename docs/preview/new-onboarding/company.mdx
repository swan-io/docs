...
All supporting documents requested during onboarding are mandatory for an onboarding to be valid and finalized.
:::
...
The `relatedIndividuals` array is required for all countries. At least one Legal Representative and one Ultimate Beneficial Owner must be provided for a company onboarding to be valid and finalized. The same individual can fulfill both roles depending on the `type`.
...
| Field | 🇫🇷<br/>France | 🇩🇪<br/>Germany | 🇮🇹<br/>Italy | 🇳🇱<br/>Netherlands | 🇪🇸<br/>Spain | 🇧🇪<br/>Belgium |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| `addressLine1` | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁶</span> | <Opt /> | <Req /> | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁶</span> | <Req /> | <Req /> |
| `addressLine2` | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> |
| `city` | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁶</span> | <Opt /> | <Req /> | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁶</span> | <Req /> | <Req /> |
| `country` | <Req /> | <Req /> | <Req /> | <Req /> | <Req /> | <Req /> |
| `postalCode` | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁶</span> | <Opt /> | <Req /> | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁶</span> | <Req /> | <Req /> |
| `state` | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> |
...
| Field | 🇫🇷<br/>France | 🇩🇪<br/>Germany | 🇮🇹<br/>Italy | 🇳🇱<br/>Netherlands | 🇪🇸<br/>Spain | 🇧🇪<br/>Belgium |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| `birthDate` | <Req /> | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁷</span> | <Req /> | <Req /> | <Req /> | <Req /> |
| `city` | <Req /> | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁷</span> | <Req /> | <Req /> | <Req /> | <Req /> |
| `country` | <Req /> | <Req /> | <Req /> | <Req /> | <Req /> | <Req /> |
| `postalCode` | <Req /> | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁷</span> | <Req /> | <Req /> | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁷</span> | <Req /> |
...
| Field | 🇫🇷<br/>France | 🇩🇪<br/>Germany | 🇮🇹<br/>Italy | 🇳🇱<br/>Netherlands | 🇪🇸<br/>Spain | 🇧🇪<br/>Belgium |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| `taxIdentificationNumber` | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁸</span> | <Req /> | <Req /> | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁸</span> | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁸</span> | <span style={{whiteSpace: "nowrap"}}><Cnd /> ⁸</span> |
...
If you use Swan's hosted onboarding, the following fields are collected during the onboarding and sign-up flows.
