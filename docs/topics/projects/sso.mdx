...
SSO is self-serve: you configure it yourself, project by project, without Swan's intervention. Swan uses [Frontegg](https://frontegg.com) to power SSO, so part of the setup happens in the Frontegg admin portal. Activating SSO doesn't disrupt phone number sign-in for your other users.
...
### Step 3: Configure your IdP in Frontegg {#setup-idp}
...
| The IT administrator can't access Frontegg | Confirm the invitation was accepted and the initial sign-in and one-time password verification were completed. |
...
| Domain verification is pending | Confirm the exact TXT record generated by Frontegg was added to the correct DNS zone, then allow time for DNS propagation. |
