...
Users may see a €5 fee when receiving euros from another account in the same country. This happens when the sending bank uses the SWIFT network instead of SEPA.
:::
