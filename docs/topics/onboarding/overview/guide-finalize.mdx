...
* You must have a [user access token](../../authentication/index.mdx#tokens-user) for the user whose onboarding you're finalizing, and the user must have accessed their onboarding URL at least one time.
