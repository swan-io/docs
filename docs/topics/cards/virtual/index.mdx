...
Canceling a virtual card is synonymous with canceling the entire card contract.
Therefore, when you cancel a virtual card, you also cancel all physical and digital cards connected to that card contract.
Consent isn't required to cancel cards.

The cancellation process is **irreversible**, immediately and permanently rendering the card unusable.
All physical and digital cards linked to the virtual card are also canceled immediately.
...
If you don't want to cancel the entire card contract, you can cancel [only a physical card](../physical/guide-cancel.mdx) or [only a digital card](../digital/guide-cancel.mdx) instead.
