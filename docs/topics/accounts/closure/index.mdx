...
### You (Partner) {#closure-partner}

| Requester | Process |
| :---: | --- |
| You (Partner) | Your guides are in this section. Follow the guide relevant to your situation.<br /><br /><ol><li>[Request to close a **limited** account](./guide-close-limited.mdx).</li><li>[Request to close an **unlimited** account](./guide-close-unlimited.mdx).</li></ol>Reason code: `ComplianceReason`<br /><br />*Learn whether an [account's payment level](../index.mdx#account-type-level) is `Limited` or `Unlimited` by going to your **Dashboard** > **Data** > **Accounts**, then clicking the account you're trying to close. The payment level is part of the account's general information.*|

### Legal representative {#closure-legal-rep}

| Requester | Process |
| :---: | --- |
| Account legal representative | <ol><li>You [send a link](./guide-close-link.mdx) to the legal representative to close the account.​</li><li>You [use the API](./guide-close-api.mdx) to close an account at the request of the account's legal representative.</li></ol>Reason code: `PartnerReason` |

### Account holder {#closure-account-holder}

| Requester | Process |
| :---: | --- |
| Account legal representative<br />*or*<br />Account holder | The [Swan Support Center](https://support.swan.io/hc/en-150/articles/14642306196765-Account-closure-process) documents the process for account holders and legal representatives. The account holder or the legal representative must contact Swan Support directly.<br /><br />Reason code: `ComplianceReason` |
...
When Swan closes an account, the reason code is `ComplianceReason`, displayed on your Dashboard.
...
The reason code for this account closure, displayed on your Dashboard, is `ComplianceReason`.
