...
:::tip Prerequisites
- You can cancel a funding source with a [project access token](/dev-tools/using-api/authentication#tokens-project), *or*
- Account members with the `canManageAccountMembership` permission can cancel funding sources with a [user access token](/dev-tools/using-api/authentication#tokens-user).
:::
...
- [Add a funding source](/accounts/guides/funding/add-source) · [Get funding information](/accounts/guides/funding/get-info) · [Initiate a funding request](/accounts/guides/funding/initiate-request)
