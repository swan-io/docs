...
<Term id="capital-deposit">Capital deposit</Term> documents have their own set of refusal reason codes; refer to the [capital deposit reference](/accounts/reference/capital-deposits#document-refusal-reasons).
