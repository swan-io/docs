...
Refer to the [example mutations](/dev-tools/tools/sandbox-users#examples) on the **Sandbox users** page.
You can only simulate an identification on [Sandbox users](/dev-tools/tools/sandbox-users#overview) who are linked to your project.
:::
