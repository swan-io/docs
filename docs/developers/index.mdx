...
### Sandbox operation limits {#sandbox-limits}
...
:::note Complexity, depth, and concurrency in Live
Exceeding these limits in your Live environment doesn't result in an error.
Nonetheless, Swan recommends keeping your Live operations within these limits as well.
:::
