...
1. Choose the [account membership language](/accounts/concepts/memberships#language) (line 18). If no language is chosen, the membership inherits the [account language](/topics/accounts/#language).
