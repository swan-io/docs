...
Learn more about `PaymentAccountType` and `PaymentLevel` in the [accounts overview section](/accounts/concepts/account#account-type-level).
...
The country prefix for local IBANs is determined by the [account country](/accounts/concepts/account#account-country).
...
| **YY** | Two-digit RIB key<br />RIB, or *relevé d'identité bancaire*, are [Swan's bank details PDF](/accounts/concepts/account#bank-details) |
...
- [Validate the format of an IBAN](/accounts/guides/ibans/validate)
...
- [Account overview](/accounts/concepts/account)
