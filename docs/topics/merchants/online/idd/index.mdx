...
| `InsufficientFunds` | The debtor has insufficient funds to fulfil the transaction. | Contact the debtor to add funds to their account, or schedule the payment for a later date. |
...
| `ReasonNotSpecifiedByBank` | The debtor's bank can't disclose the rejection reason due to local data protection laws. | Contact the debtor to check with Swan Support for more details. |
