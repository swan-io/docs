...
| --- | --- | --- | --- |
| Card transaction | Card payment was rejected due to insufficient funds | Your card payment was Card payment was rejected due to insufficient funds. Please add money to your account before trying again. | `CanViewAccount` |
| Card transaction | Card payment was rejected because the cardholder already reached their [spending limit] | Notification content | *None* |
| Card transaction | Card payment was rejected because the card is permanently blocked | Notification content | *None* |
| Card transaction | Card payment was rejected because the card's expiration date is invalid | Notification content | *None* |
| Card transaction | Card payment was rejected because the card's PIN is invalid | Notification content | *None* |
