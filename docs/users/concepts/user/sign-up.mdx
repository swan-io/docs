...
1. **Confirms their phone number**. How they confirm depends on whether they opened the sign-up link from a computer or their mobile device:
    ...
    1. **Mobile device**: Swan sends your user a text message with a verification code. The user enters this code on their mobile device to confirm their phone number.
