...
1. Copy the document collection ID from the success payload you received from #1, then paste it into the **Supporting Document Collection ID** field in the Event Simulator.
...
## Simulate changing a document purpose {#simulate-change-purpose}

With the supporting document collection ID, use the Event Simulator to [change the purpose](./index.mdx#document-purposes-types) of any supporting document..
...
1. From the dropdown, choose the purpose you'd like to assign to your document. Use the search if needed.
1. Click **Simulate**.

![Simulate changing the purpose of a supporting document with the Event Simulator](../../../images/topics/onboarding/sandbox-document-purpose.png)
