...
| `Card.Updated` | Physical card was printed, spending limit was updated, and more (doesn't include PIN notifications). |
...
| --- | --- | --- |
| `Transaction.Booked` | Transaction was completed and will appear on the account statemen. | All payment types |
