...
| `eventType` | Explanation | Applies to |
| --- | --- | --- |
| `Transaction.Booked` | Transaction was completed and will appear on the account statement | Credit transfers, direct debits and cards |
...
| `Transaction.Pending` | Transaction is being processed | Credit transfers and cards |
| `Transaction.Rejected` | Transaction was rejected | Credit transfers, direct debits and cards |
...
| `TransactionStatement.Generated` | [Transaction statement](../../topics/payments/index.mdx#transactions-statements) was generated successfully | Credit transfers, direct debits and cards |
