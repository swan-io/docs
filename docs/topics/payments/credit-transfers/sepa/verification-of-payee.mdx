  ...
  <TabItem value="not-possible" label="❌ Verification not possible">
    ...
    **Customer action**: Proceed without verification
    ...
    <details>
      ...
      ![Verification not possible consent screen](../../../../images/topics/payments/credit-transfers/vop/PC_no_verif.png)
    </details>
  </TabItem>
</Tabs>
...
Even saved beneficiaries require VoP for compliance**.
:::
...
Test VoP flows with these mock beneficiary names in Swan's sandbox environment:
...
**After (new VoP)**:
```graphql title="New VoP" showLineNumbers
