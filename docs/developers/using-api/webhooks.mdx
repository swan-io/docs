...
Swan servers wait 15 seconds for a response in Live (5 seconds in Sandbox).
If there's no response, Swan considers the webhook attempt as failed and retries until 7 retries have been attempted.
