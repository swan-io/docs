...
<table>
  ...
  <tr>
    ...
    <td>Partner uploads new documents<br /><br />💡 *If needed, [get a list of required documents](./overview/guide-get-list.mdx). Then, [upload missing documents](../accounts/documents/guide-upload.mdx).*</td>
    <td><center>`WaitingForInformation`</center></td>
    <td><center>`WaitingForDocuments`</center></td>
  </tr>
  <tr>
