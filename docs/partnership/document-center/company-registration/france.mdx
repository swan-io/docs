...
| Formulaire Personne Politiquement Exposée (PPE) | Politically Exposed Person (PEP) form | <ul><li>Will be sent to the end user (based on your communication preferences).</li><li>Must be signed and dated.</li></ul> |
| Structure de gouvernance / Organigramme | Governance structure documentation | • Required when the association's governance structure is complex or not clear from other documents.<br />• Provided by the account holder. |
| Liste des membres / Règlement d'admission | Membership list / admission rules | • Provided by the account holder. |
| Déclaration des bénéficiaires effectifs et pièce d'identité des UBOs | UBO declaration and identity documents of UBOs | <ul><li>For example:</li><ul><li>Copie intégrale des informations déclarées</li><li>Déclaration Relative au(x) Bénéficiaire(s) Effectif(s) d'une Société</li><li>Document Relatif au Bénéficiaire Effectif</li></ul><li>Must be an official document, dated, signed, and stamped.</li></ul>• Provided by the account holder. |
| Justificatif de domicile des bénéficiaires effectifs | Proof of address of UBOs | • Must be dated within the last 3 months.<br />• Provided by the account holder. |
