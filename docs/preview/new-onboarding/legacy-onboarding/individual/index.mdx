...
import IndividualOnboardingDefinition from '../partials/_onboarding-individual.mdx';
...
1. User [**signs up**](../../../../topics/users/index.mdx#signup) for Swan.
...
|`taxIdentificationNumber`|<Opt />|<Opt />| <Cnd /> ∗ | <Req /> |<Opt />|<Opt />|
...
Choose the value that best reflects your acquisition channel for each account holder.
