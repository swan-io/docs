...
Webhook events are retained for 90 days. After this period, events are no longer available for manual retry or review in your **Dashboard** > **Developers** > **Webhooks**.
:::
