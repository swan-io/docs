...
Companies of all kinds can unlock the full potential of their product by embedding Swan's banking features such as [accounts](/accounts/concepts/account), [cards](/cards), and [payments](./topics/payments/index.mdx).
