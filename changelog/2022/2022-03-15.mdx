...
💳 Cardholders can now [activate a card](/cards/guides/physical/activate) after receiving it, thanks to the new `activatePhysicalCard` mutation. They just have to input the identifier printed on the card and give their consent.

📃 [Upload supporting documents](/accounts/guides/documents/upload-onboarding) using the `generateSupportingDocumentUploadUrl` mutation during the onboarding. This way you don't have to ask users a second time by email.
