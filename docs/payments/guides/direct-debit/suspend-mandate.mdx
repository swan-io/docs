...
SEPA <Term id="direct-debit">Direct Debit</Term> instructions associated with a [`Suspended` received payment mandate](/payments/concepts/direct-debit#received-instructions-execution) are `Rejected`.
