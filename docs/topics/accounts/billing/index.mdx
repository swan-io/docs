...
| | Additional account fee | A one-time fee is charged to the account holder for opening the initial account, which covers the opening of any additional accounts associated with it.|
