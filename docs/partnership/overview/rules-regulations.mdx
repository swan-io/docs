...
1. You can brand banking services entirely as your own, without having to mention Swan as a partner. _(Note that if the product seems unclear about which entity is regulated, you might be asked to mention Swan.)_
...
Swan restricts activities in the following categories:
