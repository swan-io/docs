...
1. **Enters their personal information**, including their first name, last name, and birthdate. This information must match the information that appears on their identity documents.
...
6. Enters their **birth information**, including their birth city, postal code, and country, as well as their nationality.
    - If you include this information when creating their sign-up link, they won't need to enter it again.
1. Enters their **residency information**. Users only need to provide information relevant to the [identification process](./identifications/index.mdx#levels-processes) they're required to complete, which is determined by your location, not the user's. The correct information is requested automatically.
...
| Full API<br />*or*<br />Customized open source frontend | Your user is redirected to the `redirectUrl` you supplied when creating their sign-up link. Make sure to declare your `redirectUrl` on your **Dashboard** > **Developers** > **Redirect URIs**. Otherwise, the redirection fails. |
