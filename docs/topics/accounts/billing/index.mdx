...
Refer to the [guide to build a compliant billing offer](./guide-compliant-billing.mdx) to learn what you can and can't charge.
...
The invoice lists all banking fees charged during the **monthly billing period**, which begins on the first of each month.
**Annual fee statements** are included at the end of January's invoice.
