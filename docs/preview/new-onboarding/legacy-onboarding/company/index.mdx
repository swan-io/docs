...
:::caution Deprecated
This page documents the v1 onboarding API. It is preserved as a read-only reference. Refer to [account onboarding enhancements](../../index.mdx) for the current v2 API.
:::

import CompanyOnboardingDefinition from '../partials/_onboarding-company.mdx';
...
| Method | Details |
| --- | --- |
| Onboarding form | The onboarding form collects:<br /><br /><ol><li>User's **email address**.</li><li>Legal information about the organization, including the **company name**, **registration number** (optional), **VAT number** (optional), and **address**, as well as details about the organization's **activity** and **expected monthly volume**.</li><li>Information about the company's **ultimate beneficial owners** (UBO). This step only applies if the user selected **company**, **home owner association**, or **other**, when submitting their preliminary details.</li><li>Information about the company's **representatives**. This includes individuals or legal entities authorized to act on behalf of the company.</li><li>**Required documents** to verify your organization. You might not see this step in your onboarding process.</li></ol>After completing the form, the user signs up for Swan. You can also customize this form to better meet your needs. Review Swan's [open source documentation](https://swan-io.github.io/swan-partner-frontend/specs/onboarding/company/), then ask your PIM (Product Integration Manager) for more information. |
...
### Acquisition channel {#acquisition-channel}

Use the optional `acquisitionChannel` field to indicate how the account holder was acquired.

| Value | Description |
|-------|-------------|
| `InboundOrganic` | Account holders who signed up directly, such as through your website. |
| `InboundReferral` | Account holders acquired through referrals from existing users or partners. |
| `OutboundSales` | Account holders acquired through direct sales efforts. |
| `OutboundAccountingFirm` | Account holders acquired through accounting firm partnerships. |
...
#### Definition of a UBO {#ubo-owner}

An ultimate beneficial owner (UBO) is any individual who ultimately owns or controls a company. The most common type is an ownership of capital UBO: anyone holding more than 25% of that company's value, whether directly or indirectly.
...
Representatives are separate from the account's legal representative. The legal representative is the person who administers the Swan account and undergoes identity verification.
...
Swan supports multiple identification processes, and some require a first transfer.
...
- **Legal representative information**: The individual who administers the account and undergoes identification
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|
|`accountCountry`| <Req /><br />(`FRA`) | <Req /><br />(`BEL`) | <Req /><br />(`DEU`) | <Req /><br />(`ITA`) | <Req /><br />(`NLD`) | <Req /><br />(`ESP`) |
...
<Tabs>
  <TabItem value="individual" label="👤 Individual representative" id="representatives-individual" default>
    #### Individual representative field requirements
    ...
    **API usage**: Use `representatives` with `type: Individual` for natural person representatives.
    ...
    | API field | 🇫🇷<br/>France | 🇧🇪<br/>Belgium | 🇩🇪<br/>Germany | 🇮🇹<br/>Italy | 🇳🇱<br/>Netherlands | 🇪🇸<br/>Spain |
    |---|:---:|:---:|:---:|:---:|:---:|:---:|
    |`representatives.type`| <Req /> <br/>(`Individual`) | <Req /> <br/>(`Individual`) | <Req /> <br/>(`Individual`) | <Req /> <br/>(`Individual`) | <Req /> <br/>(`Individual`) | <Req /> <br/>(`Individual`) |
  ...
  <TabItem value="company" label="🏢 Company representative" id="representatives-company">
    #### Company representative field requirements
    ...
    **API usage**: Use `representatives` with `type: Company` for legal entity representatives.
    ...
    | API field | 🇫🇷<br/>France | 🇧🇪<br/>Belgium | 🇩🇪<br/>Germany | 🇮🇹<br/>Italy | 🇳🇱<br/>Netherlands | 🇪🇸<br/>Spain |
    |---|:---:|:---:|:---:|:---:|:---:|:---:|
    |`representatives.type`| <Req /> <br/>(`Company`) | <Req /> <br/>(`Company`) | <Req /> <br/>(`Company`) | <Req /> <br/>(`Company`) | <Req /> <br/>(`Company`) | <Req /> <br/>(`Company`) |
    |`representatives.roles`| <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> |
    |`representatives.entityName`| <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> |
    |`representatives.registrationNumber`| <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> |
    |`representatives.legalForm`| <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> |
    |`representatives.residencyAddress.addressLine1`| <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> |
    |`representatives.residencyAddress.addressLine2`| <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> |
    |`representatives.residencyAddress.city`| <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> |
    |`representatives.residencyAddress.country`| <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> | <Opt /> |
