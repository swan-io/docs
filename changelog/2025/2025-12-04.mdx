...
- **[Account memberships](/topics/accounts/memberships/#notifications)**: Join your banking space.

Additional notifications can be configured with your Account Manager. Your current configuration has been applied automatically to avoid disruptions.
...
📩 Starting **December 18**, [account membership invitations](/topics/accounts/memberships/#invite) migrate to the new branded notification template. If you use a forked version of Web Banking, fetch and deploy the latest version from Swan's repository to continue receiving Swan-sent invitation emails.