...
- **Individual accounts**: Verification tokens always required.
- **Company accounts**: Verification tokens optional by default, can be made required through account settings.
...
[Learn more about bulk credit transfers with VoP →](bulk-credit-transfers)
