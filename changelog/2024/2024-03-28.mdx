...
Learn more about the [supporting document collection](/accounts/concepts/documents).

🧪 [Simulate](/accounts/reference/sandbox/sandbox-documents) a supporting document status update.
