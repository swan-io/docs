...
:::tip Prerequisites
1. Confirm the account member has the [correct account membership permissions**](/accounts/reference/memberships/membership-permissions#permissions-cards) to manage cards and, if needed, account memberships.
1. [Add a virtual card](/cards/guides/virtual/add) **before** printing a physical card with the `printPhysicalCard` mutation.
:::
...
1. Choose [card settings](/cards/reference/card-settings#settings) and set the spending limit (lines 6-12).
...
:::tip Prerequisites
Confirm the account member printing the cards has the [**correct account membership permissions**](/accounts/reference/memberships/membership-permissions#permissions-cards) to manage cards **and** account memberships.
:::
...
1. Add a `card` block for each card you'd like to print (example: lines 15-27).
    ...
    1. Choose [card settings](/cards/reference/card-settings#settings) and set the spending limit (lines 17-21).
