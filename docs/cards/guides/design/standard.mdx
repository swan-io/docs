...
![Screenshot of the Dashboard modal to add a new card product](../../../images/topics/cards/cards-configure-create-1.png)

3. Name your new card product.
4. If you'd like to allow physical cards, toggle **Allow physical cards** to **on**.
5. Click **Create**.

![Screenshot of the Dashboard cards settings page with three card products](../../../images/topics/cards/cards-configure-create-2.png)
...
![Screenshot of the Dashboard settings page for a specific card product calling out design options](../../../images/topics/cards/cards-configure-2.png)
