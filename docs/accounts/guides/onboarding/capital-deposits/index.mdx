...
A capital deposit case moves through several statuses. See [Capital deposit case statuses](/accounts/reference/onboarding/capital-deposit-reference#case-statuses).

### Cancelation reason codes {#cancelation-reason-codes-leadin}

When a case is canceled, a reason code explains why. See [Cancelation reason codes](/accounts/reference/onboarding/capital-deposit-reference#cancelation-reason-codes).
...
Several documents are required from shareholders and the future company. See [List of required documents](/accounts/reference/onboarding/capital-deposit-reference#documents-list).

### Document statuses {#documents-statuses-leadin}

Each document moves through statuses as Swan reviews it. See [Document statuses](/accounts/reference/onboarding/capital-deposit-reference#documents-statuses).
...
Each shareholder moves through several statuses as they onboard and transfer funds. See [Shareholder statuses](/accounts/reference/onboarding/capital-deposit-reference#shareholders-statuses).
...
- Updates the [case status](/accounts/reference/onboarding/capital-deposit-reference#case-statuses) to `WaitingForShareDepositCertificate` so it gets sent to the notary.
