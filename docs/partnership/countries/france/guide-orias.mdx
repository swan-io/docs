...
In English, this translates roughly to *Authorized Bank and Payment Services Agent*.
...
Swan can help set you up for the necessary training.
:::
...
1. If you'd like, change the language from French to English.
...
<Tabs>
  <TabItem value="french" label="français" default>
    <div>
...
:::caution French only
From this point forward, Orias is only available in French.
:::

### 3.1 Register your company {#registration-1}

1. Click **Nouvelle inscription** (translates roughly to **New registration**) to start your registration. A form appears.
...
1. For the first question, choose the answer **Je déclare que l'on ne me confie pas de fonds**, which roughly translates to **I declare that no funds are entrusted to me**.
...
1. Notice that you're paying for **Mandataire non-exclusif en opérations de banque et en services de paiement** registration. Without paying the fee (blurred out in these images), your registration isn't complete.
...
After receiving your Orias registration number by email, **Swan registers you** as a *Mandataire non-exclusif en opérations de banque et en services de paiement (MOBSP)*.
In English, this translates roughly to *Authorized Bank and Payment Services Agent*.
...
After receiving approval from Orias and becoming an MOBSP, make sure to update all of your legal mentions.
