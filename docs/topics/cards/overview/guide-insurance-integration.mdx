...
Swan automatically creates a [card insurance subscription](/topics/cards/overview/card-insurance#insurance-subscription) when a new card is issued, if the following conditions are met:
