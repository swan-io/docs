...
<table>
  ...
  <tr>
    ...
    <td>
      <a href="../../onboarding/index.mdx">Onboarding</a> finalized
    </td>
    <td>
      <center>`NotStarted`</center>
    </td>
    <td>
      <center>`PendingReview`</center>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      Legal representative completes{" "}
      <a href="../../users/identifications/index.mdx">identification</a>
    </td>
    <td>
  ...
  <tr>
    ...
    <td>
      <center>`WaitingForInformation`</center>
    </td>
    <td>
      <center>`WaitingForDocuments`</center>
    </td>
  </tr>
  <tr>
    <td colspan="3">
      → *Subscribe to the `supportingDocumentCollection.updated`{" "}
      <a href="../../../developers/using-api/webhooks.mdx">webhook</a>. You'll
      be notified when a request is sent to collect documents.*
    </td>
  </tr>
  <tr>
    <td rowspan="2">
  ...
  <tr>
    <td colspan="3">
      → *If needed,{" "}
      <a href="./guide-get-list.mdx">get a list of required documents</a>. Then,{" "}
      <a href="./guide-upload.mdx">upload missing documents</a>.*
    </td>
  </tr>
  <tr>
    <td rowspan="2">
  ...
  <tr>
    <td colspan="3">
      → *Partners (you) need to request a supporting document collection review
      after all supporting documents are uploaded.{" "}
      <a href="./guide-request-collection-review.mdx">Request a review</a> with
      the API or from your Dashboard.*
    </td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td colspan="3">
      → *<a href="./guide-get-list.mdx">Get the list of required documents</a>
      and review the rejection reason. Then, return to step 4.*
    </td>
  </tr>
</table>
