...
- You have a project access token, or, if you're an account member, a user access token with `CanManageAccountMembership` [membership permission](/accounts/reference/membership-permissions#permissions).
:::
