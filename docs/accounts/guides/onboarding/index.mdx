...
During onboarding, users also [complete an account holder verification](/accounts/concepts/account-holders/verification#verification-process) process and [authenticate](/dev-tools/using-api/authentication) (log in) for the first time.
