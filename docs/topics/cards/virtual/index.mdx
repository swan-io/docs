...
| `Suspended` | Virtual card is suspended and not available for use<br/><br/>Cards can be suspended for various reasons, including a request from you or the card holder, or a Swan action in the case of suspicious activity |
