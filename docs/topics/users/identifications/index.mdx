...
Swan users need to **prove their identities** at key points during their user journey: during [account onboarding](../../onboarding/index.mdx), when accepting an [account membership](../../accounts/memberships/index.mdx), and if they need to reset their password.
