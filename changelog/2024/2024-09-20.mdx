...
📥 **Provide transaction [supporting documents](/accounts/concepts/documents) with the API**.
...
📨 **[Proactively share supporting documents](/accounts/guides/documents/upload-transaction/using-the-api) when initiating an transaction with the API**.
