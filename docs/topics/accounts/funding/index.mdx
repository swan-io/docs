...
:::note
Account verification for funding sources **isn't related** to [account holder verification status](/accounts/guides/onboarding/account-holders#verification-process-statuses) used during account onboarding, or the general [account status](../index.mdx#statuses).
:::
