...
User access tokens allow you to act on behalf of an individual user in your project, often with the goal of [executing sensitive operations](/users/reference/sensitive-operations).
...
![Image of Dashboard API page focused on credentials](../../images/build/authentication/token-project-credentials.png)
...
![Image of Dashboard API page focused on credentials](../../images/build/authentication/token-user-credentials.png)
...
Read about why in the [integrate Strong Customer Authentication](/users/guides/consent/integrate-sca) guide.
:::
...
Sometimes, a phone number might have been used by a [deactivated user](/users/concepts/user/deactivation) before being used for a new user.
...
1. Act as the legal representative to perform [server-to-server consent](/users/concepts/consent/server-to-server) operations.
