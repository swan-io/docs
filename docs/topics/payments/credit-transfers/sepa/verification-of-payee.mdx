...
flowchart TD
    ...
    subgraph " "
        D["✅ Match<br/>Ready to proceed"]
        E["⚠️ Close Match<br/>Check suggested name"]  
        F["❌ No Match<br/>Verify details before proceeding"]
        G["❌ Verification Not Possible<br/>Verification service unavailable"]
    end
