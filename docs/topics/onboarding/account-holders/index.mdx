...
| Additional documents requested | Swan received the first transfer and asked the user for [supporting documents](../../accounts/documents/index.mdx). | `WaitingForInformation` |
