...
The `beneficiaryVerification` query will be deprecated on October 9, 2025. Migrate to the new [Verification of Payee (VoP)](/preview/vop/verification-of-payee) instead before the compliance deadline.
:::
