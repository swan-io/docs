...
Every <Term id="cards-physical">physical card</Term> moves through the following statuses over its lifetime, from <Term id="consent">consent</Term> through activation, suspension, and cancelation.
