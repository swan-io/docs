...
✖️ Partners can [cancel a capital deposit](/topics/capital-deposits/guide-cancel) case in the early stages of a case with the API mutation `cancelCapitalDepositCase`.
...
We announced it's deprecation on [November 30th](/changelog/30-november-2023), and it's replaced with the `identificationLevels` booleans and identification collection.