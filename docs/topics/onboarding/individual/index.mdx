...
:::caution Individual onboarding in Live
Individual onboarding is only available in Live for projects Swan has approved.
For all other projects, Swan rejects individual onboarding mutations in Live, and individual public links don't appear in the Dashboard.
All projects can still create individual onboardings in Sandbox.
[Capital deposits](../../capital-deposits/index.mdx) aren't affected: individual shareholders can still be onboarded.
:::
