...
| `CardDetailsInvalid` | The card details provided are incorrect or incomplete. | Double-check the card number, expiration date, and CVC. If the issue persists, contact your card issuer for verification and more information. |
