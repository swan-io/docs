...
During onboarding, users also [complete an account holder verification](./account-holders/index.mdx#verification-process) process, [consent to open the account](../users/consent/index.mdx), and [authenticate](https://docs.swan.io/guide/create-a-new-account#first-authentication-and-callback) (log in) for the first time.
:::
