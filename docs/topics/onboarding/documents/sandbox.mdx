...
### Step 1: Get the collection ID {#simulate-collection-status-get-id}
...
### Step 2: Update the collection status {#simulate-collection-status-update}
...
### Step 1: Get the document ID {#simulate-document-status-get-id}
...
### Step 2: Update the document status {#simulate-document-status-update}
