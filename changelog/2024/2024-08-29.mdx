...
⛔ In **8 weeks**, if you call the API with a [user access token](/developers/using-api/authentication/#tokens-user) attributed to a `Suspended` user, it will be rejected.