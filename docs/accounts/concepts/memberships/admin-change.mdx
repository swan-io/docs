...
Track and update an ongoing change request programmatically with the `publicAccountAdminChange` query and its companion mutations — review [Using the API in the guide](/accounts/guides/memberships/change-admin#api).
