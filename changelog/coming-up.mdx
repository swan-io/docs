...
⚠️ Starting **October 31st**, the `taxIdentificationNumber` will be a mandatory field during onboarding when an account holder's residency country doesn't match the `accountCountry`. This is to comply with [CRS (Common Reporting Standard) regulations](https://www.oecd.org/content/dam/oecd/en/topics/policy-issue-focus/aeoi/jersey-guidance-notes-crs.pdf).
