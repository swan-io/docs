...
:::warning
Starting October 9, 2025, Swan automatically includes [Verification of Payee (VoP)](/preview/verification-of-payee) in all SEPA Credit Transfers to comply with the EU Instant Payments Regulation.
:::
...
The `beneficiaryVerification` query will be deprecated. Plan [your migration](/preview/verification-of-payee) before the compliance deadline to ensure uninterrupted service.
:::
