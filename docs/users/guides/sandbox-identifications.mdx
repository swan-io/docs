...
You can only simulate an <Term id="identification">identification</Term> on [Sandbox users](/build/tools/sandbox-users#overview) who are linked to your project.
:::
