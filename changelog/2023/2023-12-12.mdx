...
⚠️ On February 5, we're doing a database migration of our webhooks.
Only logs from January 1 on will be migrated, meaning all data from 2023 and before will be lost.
From February 5 on, webhook history will only be kept for 100 days.
