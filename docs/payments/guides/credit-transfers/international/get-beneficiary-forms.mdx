...
related:
  ...
  - /payments/guides/credit-transfers/international/get-transaction-forms
---

# Get beneficiary information

Get beneficiary information for a Swan <Term id="credit-transfer">International Credit Transfer</Term>.
...
It only includes the route `type` `FedwireLocal` to reduce the length, and **country and state codes were removed** and replaced with placeholders (lines 77-78, 112-113).
:::

<details>
  <summary>**Open to review the second payload** for your international beneficiary query</summary>
  <div>
```json {6,11,77-78,105,109,112-113,132} showLineNumbers
{
  "data": {
    "internationalBeneficiaryDynamicForms": {
      "schemes": [
