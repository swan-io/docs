...
<p className="ia-lede">How card transactions work at Swan: categories, authorization and clearing, 3-D Secure, international payments, fraud, and enriched merchant data.</p>
...
- **eCommerce**: Online transactions without 3-D Secure consent.
...
Note that [Mastercard's exchange rate](https://www.mastercard.com/content/mastercardcom/global/en/personal/get-support/convert-currency.html) applies to card transactions outside of [SEPA](/payments/concepts/transactions#sepa).
...
With 3DS, cardholders are required to perform [Strong Customer Authentication](/users/concepts/consent#sca) before finalizing their payment.
