...
If you forked Swan's Web Banking before the migration to branded partner notifications, you must update your forked Web Banking to continue relying on Swan to send the invitation notification by email.
:::
