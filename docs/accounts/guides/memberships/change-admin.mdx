...
description: >-
  Change the legal representative for a company account holder with a structured
  review process, supporting document collection, and identity verification.
audience:
  - ops
related:
...
Submit a [Swan Support request](https://supportform.swan.io/) with the account holder information (IBAN or account holder name).
