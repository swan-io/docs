...
To help you and your users keep track of fees, Swan **generates a dedicated invoice** automatically for all Swan company account holders, generated at the same time as the [monthly account statement](/accounts/concepts/account#account-statements).
...
Swan **generates a dedicated invoice** automatically for all **company** account holders, generated at the same time as the [monthly account statement](/accounts/concepts/account#account-statements).
The invoice lists all banking fees charged during the **monthly billing period**, which begins on the first of each month.
...
Subscribe to the `AccountInvoice.Generated` [webhook](/dev-tools/using-api/webhooks) to receive a notification each time an invoice is generated.
...
Instead, fees are included on the standard [monthly account statement](/accounts/concepts/account#account-statements).
...
- [Build a compliant billing offer](/accounts/guides/billing/compliant-billing)
- [Get list of invoices](/accounts/guides/billing/get-list)
- [Get invoice details](/accounts/guides/billing/get-details)
- [Sandbox: billing](/accounts/reference/sandbox-billing)
- [Account funding](/accounts/concepts/funding)
- [Supporting documents](/accounts/concepts/documents)
