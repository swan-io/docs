...
Swan runs the check when `initiateCreditTransfers` is called and shows the result on the <Term id="consent">consent</Term> screen. No development needed for single transfers.
