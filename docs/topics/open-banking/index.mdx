...
Open Banking testing happens in Salt Edge's own sandbox, not in Swan's Sandbox environment.
To get sandbox access, contact Salt Edge at [compliance-hub@saltedge.com](mailto:compliance-hub@saltedge.com).
