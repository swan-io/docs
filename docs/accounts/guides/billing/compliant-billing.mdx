...
Build a compliant billing offer that charges only qualified fees to your end users, with or without customization.
...
Swan Partners aren't [acting as regulated financial entities](/get-started/become-a-partner), so you **can't bill directly** for banking fees, even if your product provides support associated with these fees.
...
Note that **you are ultimately responsible** for any outstanding payments owed by your users.
...
![Visual depiction of three payments going to three French virtual IBANs attached to a single French main IBAN](../../../images/accounts/billing-present-offer.png)
