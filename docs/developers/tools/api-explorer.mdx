...
Swan is an API-first product, and the API Explorer provides a way to test all of Swan's features.
...
- Maximum of 1,000 fields per query
...
2. Switch between [**access tokens**](../../topics/authentication/index.mdx#tokens):
