...
The previous [`onboardIndividualAccountHolder`](https://api-reference.swan.io/mutations/onboard-individual-account-holder/) mutation is deprecated and will be removed in December 2026.
