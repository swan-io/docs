...
Swan **shares the authorization decision** with you through [payment control](/dev-tools/using-api/payment-control).
...
Subscribe to both [webhooks](/dev-tools/using-api/webhooks) to stay updated on your transactions.
