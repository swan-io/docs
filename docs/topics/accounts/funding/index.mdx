...
Account verification for funding sources occurs when Swan attempts to verify that an external account used for funding is accessible to the account holder or account member funding the Swan account.
...
|:---:|---|
| `PendingVerification` | The funding source was added and account access is being verified.<br /><br />*Please note that the funding source status can be `Enabled` even if the account verification status is `PendingVerification`.* |
| `Verified` | Swan verified that the external account used for funding is accessible to the account holder or member funding the Swan account. |
| `Rejected` | Swan couldn't verify that the external account used for funding is accessible to the account holder or member funding the Swan account. |
