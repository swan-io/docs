...
✖️ Partners can [cancel a capital deposit case](/accounts/guides/onboarding/capital-deposits/cancel) in the early stages of a case with the API mutation `cancelCapitalDepositCase`.
