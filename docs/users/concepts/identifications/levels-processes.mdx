...
Two key terms are essential to understand <Term id="identification">identifications</Term> at Swan: **levels** and **processes**.
...
Find the [list of identificationLevels](https://explorer.swan.io?query=%3D%3D&tab=api) in the `user` query.
