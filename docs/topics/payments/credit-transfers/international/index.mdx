...
:::note Local transfer fees
Users may see a €5 fee when receiving euros from another account in the same country. This happens when the sending bank uses the SWIFT network instead of SEPA. Share this [Swan Support Center article](https://support.swan.io/hc/en-150/articles/20983746712861-Currency-exchange-and-fees-for-International-Credit-Transfers) with your users to help them understand these fees.
:::
