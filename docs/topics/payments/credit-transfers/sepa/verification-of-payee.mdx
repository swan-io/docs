...
🔎 [Open the mutation in API Explorer](https://explorer.swan.io?query=%3D&tab=api)
...
<Tabs>
  <TabItem value="match" label="✅ Match" default>
    ...
    **UI recommendation**: Green checkmark, "Verified" badge
    ...
    **Next steps**: Use the `verificationToken` when [initiating your credit transfer](#use-token).
  </TabItem>
  ...
  <TabItem value="close" label="⚠️ Close Match">
    ...
    **UI recommendation**: Yellow warning, show suggestion to user
    ...
    **Next steps**: Display the `nameSuggestion` to the user. They can update the name or proceed with the original details.
  </TabItem>
  ...
  <TabItem value="no-match" label="❌ No Match">
    ...
    **UI recommendation**: Red warning, confirmation dialog
    ...
    **Next steps**: Warn the user about the mismatch. Allow them to double-check details or proceed with caution.
  </TabItem>
  
  <TabItem value="not-possible" label="❌ Not Possible">
    **Result**: Verification unavailable
    
    **Action**: Proceed without verification
    
    **UI recommendation**: Gray info, optional verification note
    ...
    **Next steps**: Inform the user that verification isn't available for this beneficiary. Payment can still proceed.
  </TabItem>
</Tabs>
...
:::tip Best practice
Perform verification immediately after beneficiary details are entered for optimal user experience.
:::
