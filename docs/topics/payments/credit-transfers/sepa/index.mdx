...
1. Credit transfers can't be sent if [**account holder verification**](/accounts/guides/onboarding/account-holders#verification-process) is still **in progress**.
...
Learn more about [limited account restrictions](/accounts/guides/onboarding/account-holders#limited-account-restrictions).
