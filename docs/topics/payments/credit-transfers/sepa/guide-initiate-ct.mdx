...
Starting October 9, 2025, Swan automatically includes [Verification of Payee (VoP)](verification-of-payee) in all SEPA Credit Transfers per the EU Instant Payments Regulation. Consider integrating the [`verifySepaBeneficiary` mutation](verification-of-payee#guide-verify) for optimal user experience.
:::
