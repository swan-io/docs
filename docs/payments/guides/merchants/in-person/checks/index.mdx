...
- [Accept payments with French checks (step-by-step)](./accept.mdx)
- [Request French checks payment method](./request.mdx)
- [Initiate a French check transaction](./initiate.mdx)
- [Sandbox](/payments/reference/sandbox/sandbox-merchant-checks)