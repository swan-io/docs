...
- If the card was blocked because the PIN was entered incorrectly three times, the card holder must enter their PIN at an ATM before the card is can be used again.