...
🔔 Activate [text message notifications](/topics/projects/#notifications) about rejected card payments from your **Dashboard** > **Settings** > **Notifications**, delivered in the [account membership language](/accounts/concepts/memberships#language).
