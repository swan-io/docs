...
:::tip Impersonation
If the user access token attributed to your [project's legal representative](./index.mdx#s2s-project-legal-rep) expires and interrupts your process, consider [impersonating the legal representative with a project access token](/dev-tools/using-api/authentication#impersonate) instead.
:::
