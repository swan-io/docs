...
Company accounts can opt-out of VoP for bulk transfers through the `updateBulkVerificationOfPayeeSetting` mutation. Individual accounts cannot opt-out.
...
<Tabs>
  ...
  <TabItem value="close" label="⚠️ Close match">
    **Recommended actions**: 
    ...
    - Offer to update beneficiary name
    - Allow proceeding with original or suggested name
  ...
  <TabItem value="no-match" label="❌ No match">
    **Recommended actions**: 
    ...
    - Option to verify IBAN with recipient
  ...
  <TabItem value="not-possible" label="❌ Verification not possible">
    **Recommended actions**: 
    - Explain verification unavailable
    - Suggest checking IBAN format
    - Option to contact recipient's bank
    - Allow proceeding with caution
