...
| **Over capture** | The merchant attempts to take more funds from the customer than the original authorization amount. | The cardholder makes a transaction for $100 (in USD). Therefore, the authorized amount is 100€. Currency exchange fluctuates, so the merchant captures 110€ instead of 100€. |
