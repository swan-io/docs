...
Generate an upload URL and send the <Term id="supporting-documents">supporting documents</Term> required to complete a France <Term id="capital-deposit">capital deposit</Term> case.
...
1. Add the `GenerateCapitalDepositDocumentUploadUrlSuccessPayload` with the `uploadUrl`.
...
You can also change the documents you already uploaded as long as the [document status](/accounts/concepts/capital-deposits/statuses#documents) remains `Uploaded`.
