...
1. Act as the legal representative to perform [server-to-server consent](../consent/index.mdx#s2s) operations.
1. Get updated or refreshed user data with a [webhook notification](../../developers/using-api/webhooks.mdx) on the `user` object.
