...
🔎 Starting on **December 4th**, we're removing the `user.idVerified` field.
Please start using the [new field `user.identificationsLevels.expert`](https://api-reference.swan.io/objects/identification-levels/#identificationlevelsexpertboolean--).
