...
```flowmap
{
  ...
  "items": [
    ...
    { "type": "Guide", "title": "Cancel the physical card", "to": "/topics/cards/physical/guide-cancel" },
    { "type": "Guide", "title": "Order a new physical card", "to": "/topics/cards/physical/guide-print" }
  ]
}
```
