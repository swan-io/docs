...
**Configuration**: Swan can configure this notification on your behalf. The available communication options are the same as for the first transfer notification. You can view its configuration in your **Dashboard** under **Settings** > **Notifications**, but it can't be edited there. To update it, contact Swan.
...
* [Update account holder information](./guide-update.mdx)
