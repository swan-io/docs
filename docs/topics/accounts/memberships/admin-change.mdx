...
1. You contact Swan's support team to initiate the request. Swan creates the account administrator change and generates a **form URL**. Partners can't generate this URL themselves. All requests go through a support ticket to keep all exchanges in one place.
1. Swan shares the form URL with you to forward to the requester, who fills in the new administrator's details and uploads the required supporting documents.
