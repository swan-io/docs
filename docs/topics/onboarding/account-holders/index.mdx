...
Users must complete re-verification **within 90 days**. If they do not, we will automatically suspend their account and restrict all related IBANs, cards, and payment capabilities until verification is complete.
:::
...
After Swan validates the review, the account holder re-verification status changes to `Verified`.
...
| **First reminder** | Month 1 | Your user receives a reminder if they haven't completed the portal flow. |
| **Second reminder** | Month 2 | Your user receives a second reminder if they haven't completed the portal flow. |
