...
1. Identification status
    - Simulate all the states during the identity verification process.
1. Identification levels
    - Simulate all [identification levels](https://docs.swan.io/concept/user#identification-level) (PVID, QES, Expert).
    - If one of the identification levels is selected, the Sandbox user is considered verified regardless of the identification status.
1. Auto consent
