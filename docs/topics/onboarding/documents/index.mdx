...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      [identification](../../users/identifications/index.mdx)
    </td>
    <td>
  ...
  <tr>
    <td colspan="3">
      ...
      [webhook](../../../developers/using-api/webhooks.mdx). You'll be notified
      when a request is sent to collect documents.*
    </td>
  </tr>
  <tr>
    <td rowspan="2">
  ...
  <tr>
    <td colspan="3">
      → *If needed, [get a list of required documents](./guide-get-list.mdx).
      Then, [upload missing documents](./guide-upload.mdx).*
    </td>
  </tr>
  <tr>
    <td rowspan="2">
  ...
  <tr>
    <td colspan="3">
      ...
      after all supporting documents are uploaded. [Request a
      review](./guide-request-collection-review.mdx) with the API or from your
      Dashboard.*
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3">
      → *[Get the list of required documents](./guide-get-list.mdx) and review
      the rejection reason. Then, return to step 4.*
    </td>
  </tr>
</table>
