...
<details>
  ...
  <div>
🚫 On **January 20th**, we removed the filters from the following resources:  `accountMemberships.firstName`,  `accountMemberships.lastName`,  `accountHolders.firstName`, `accountHolders.lastName`, `onboardings.email`, `users.firstName`, and `users.lastName`.
...
We also deprecated the `addMerchantProfile` mutation.
