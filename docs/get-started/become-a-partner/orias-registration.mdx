...
Companies based in France operate with the [legal status](/get-started/become-a-partner/licence-regulatory-status#legal-status) **Registered Swan Intermediary**.
...
As an MOBSP, you're regulated by **Orias**, an association that approves and monitors insurance, banking, and investment intermediaries in France.
...
Though the process is yours to complete, Swan can help along the way.
Submit a request to [Swan Support](https://partner-support.swan.io/hc/en-gb/requests) if you have questions about the process.
...
![Image of Orias list of valid supporting documents](../../images/get-started/become-a-partner/orias/orias-document-examples.png)
...
<Tabs>
  <TabItem value="french" label="French" id="open-form-french" default>
    #### Open the registration form in French

    <div>
        <img src={require("../../images/get-started/become-a-partner/orias/orias-register-fr.png").default} alt="Screenshot of Orias website leading to register in French" />
    </div>
  </TabItem>
  <TabItem value="english" label="English" id="open-form-english">
    #### Open the registration form in English

    <div>
        <img src={require("../../images/get-started/become-a-partner/orias/orias-register-en.png").default} alt="Screenshot of Orias website leading to register in English" />
    </div>
  </TabItem>
</Tabs>
...
1. Enter information about your [**legal representative**](/get-started/set-up-swan/glossary#legal-representative).
...
<Tabs>
  <TabItem value="french" label="French" id="enter-info-french" default>
    #### Enter your information on the French form

    <div>
        <img src={require("../../images/get-started/become-a-partner/orias/orias-form-fr.png").default} alt="Screenshot of Orias registration form in French" />
    </div>
  </TabItem>
  <TabItem value="english" label="English" id="enter-info-english">
    #### Enter your information on the English form

    <div>
        <img src={require("../../images/get-started/become-a-partner/orias/orias-form-en.png").default} alt="Screenshot of Orias registration form in English" />
    </div>
  </TabItem>
</Tabs>
...
![Image of Orias account to click nouvelle inscription](../../images/get-started/become-a-partner/orias/orias-new-inscription.png)
...
![Image of Orias account additional information step](../../images/get-started/become-a-partner/orias/orias-additional-information.png)
...
![Image of Orias registration supporting documents step](../../images/get-started/become-a-partner/orias/orias-supporting-documents.png)
...
![Image of Orias registration payment step](../../images/get-started/become-a-partner/orias/orias-payment.png)
...
- [Licence and regulatory status](/get-started/become-a-partner/licence-regulatory-status): Swan's licence and your legal status.
- [Become a partner](/get-started/become-a-partner): the partnership model.
