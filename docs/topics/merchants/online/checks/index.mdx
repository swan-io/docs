...
Merchants can accept payments using French checks if the debtor's bank is located in **mainland France** and the following **overseas territories**: Guadeloupe, French Guiana, Martinique, Mayotte, Reunion, Saint Martin, and Saint Barthelemy. 
