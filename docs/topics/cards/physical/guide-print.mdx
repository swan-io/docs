...
When you do this, make sure you are authenticated with a user access token belonging to a member with the `canManageAccountCards` permission.
...
Refer to Swan's [card delivery times](./index.mdx#shipping) for more information.
