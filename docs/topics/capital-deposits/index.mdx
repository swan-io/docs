...
**Capital deposit** *<CapitalDepositDefinition />*
...
| `WaitingForVerification` | Possible status if the account holder verification isn't complete at the moment the shareholder's account is created<br/><br/>*Status bypassed if the [account holder status](../onboarding/account-holders/index.mdx#account-holder-verification-statuses) is already `Verified`* |
