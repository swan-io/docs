...
Local <Term id="ibans">IBANs</Term> aren't a different type of IBAN, but rather a **characteristic** of main (and virtual) IBANs.
...
French IBANs consist of 27 letters and numbers.<br />
...
| **XX XXXX XXXX X** | 11-digit account number (not applicable for virtual IBANs) |
| **YY** | Two-digit RIB key<br />RIB, or *relevé d'identité bancaire*, is [Swan's bank details PDF](/accounts/concepts/account/bank-details) |
...
| **XXX XXXX XX** | Remaining nine digits of the 10-digit account number, which starts with the IBAN type digit `Z` (not applicable for virtual IBANs) |
