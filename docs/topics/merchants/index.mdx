...
| Merchant's own SCI | **Merchant's name** | Requires [updating the merchant payment method](./online/sdd/guide-update.mdx) through the API. French merchants can request an SCI from Swan Support. |
