...
1. You **can't manage sensitive operations** yourself (for example, [Strong Customer Authentication](/topics/users/consent/#sca)), although you may participate in collecting required documentation.
...
To learn about how Swan handles fees and your options to charge your users, refer to the guide to [build a compliant billing offer](/topics/accounts/billing/guide-compliant-billing).
:::
