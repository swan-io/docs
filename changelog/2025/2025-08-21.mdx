...
💳 [**Payment Control**](https://docs.swan.io/developers/using-api/payment-control/) now supports 0€ authorizations and credit authorizations, identifiable with `TransactionSide!` as `Credit`. Activate this feature from your **Dashboard** > **Developers** > **Payment control**.
