...
Consider the [basic API flow](/dev-tools#overview) for reference.
...
### [Account holders](/accounts/guides/onboarding/account-holders) {#events-account-holders}
...
### [Capital deposits](/accounts/guides/onboarding/capital-deposits) {#events-capital-deposits}
...
### [Cards](/topics/cards/) {#events-cards}
...
### [Merchants](/topics/merchants/) {#events-merchants}
...
### [Payments](/topics/payments/) {#events-payments}
...
### [Transactions](/topics/payments/#transactions) {#events-transactions}
...
| `Transaction.Enriched` | [Enriched transaction information](/topics/payments/cards/#enriched) was received outside of a status update. | Cards |
...
| `TransactionStatement.Generated` | [Transaction statement](/topics/payments/#transactions-statements) was generated successfully. | All payment types |
...
- [Payment control](/dev-tools/using-api/payment-control) · [Errors & rejections](/dev-tools/using-api/errors-rejections) · [Authentication](/dev-tools/using-api/authentication)
