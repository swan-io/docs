...
![Screenshot of the Dashboard cards settings page with two card products](../../../images/topics/cards/cards-dashboard-settings.png)
...
1. Review the **spending limits** for individuals and companies. (Learn more about [managing spending limits](https://docs.swan.io/concept/payment/card-payment#spending-limits) in the card payments section.)
1. Click **Suspend card product** if you need to block this card product. Suspended card products **can** be reactivated.

![Screenshot of the Dashboard cards settings page with two card products](../../../images/topics/cards/cards-dashboard-settings-detailed.png)