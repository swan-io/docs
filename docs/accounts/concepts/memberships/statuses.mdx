...
- The information you submitted about the invited account member doesn't match the information they provided when [signing up for an account](/users/concepts/user#signup).
