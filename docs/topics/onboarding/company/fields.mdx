...
If you provide `accountAdmin` information through the API and include the onboarding ID in the [OAuth redirect parameters](#oauth-redirect-parameters), Swan pre-fills this information during the [user sign-up flow](/topics/users/#signing-up).
:::
