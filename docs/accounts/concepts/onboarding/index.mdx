...
<table>
  ...
  <tr>
    ...
    <td>Partner uploads new documents<TableTip>If needed, [get a list of required documents](/accounts/guides/onboarding/manage-onboardings#get-list). Then, [upload missing documents](/accounts/guides/documents/upload-onboarding).</TableTip></td>
    <td><center>`WaitingForInformation`</center></td>
    <td><center>`WaitingForDocument`</center></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>(b) Swan **needs more documents** to verify the account holder<TableTip>[Get the list of required documents](/accounts/guides/onboarding/manage-onboardings#get-list) and review the rejection reason. Then, return to step 4.</TableTip></td>
    <td><center>`WaitingForInformation`</center></td>
    <td><center>`WaitingForDocument`</center></td>
  </tr>
</table>
