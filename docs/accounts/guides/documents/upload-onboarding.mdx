...
Upload supporting documents for an account onboarding, with the API or from your Dashboard.

You can upload supporting documents **using the API** or on the **Dashboard**.

:::tip Prerequisites
Before you can upload a document, the [collection status](/accounts/concepts/documents#collection-statuses) must be `WaitingForDocument`.
:::
...
- [Supporting documents](/accounts/concepts/documents) — collection statuses, purposes, and types.
- [Request a collection review](/accounts/guides/documents/request-collection-review) — ask Swan to review the collection once documents are uploaded.
- [Upload transaction documents](/accounts/guides/documents/upload-transaction) · [Get document information](/accounts/guides/documents/get-info)
