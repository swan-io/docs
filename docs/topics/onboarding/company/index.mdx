...
| Method | Details |
| --- | --- |
| Onboarding form | The onboarding form collects:<br /><br /><ol><li>User's **email address**.</li><li>Legal information about the organization, including the **company name**, **registration number**, **VAT number** (optional), and **address**, as well as details about the organization's **activity** and **expected monthly volume**.</li><li>Information about the company's **related individuals** (ultimate beneficial owners (UBOs) and legal representatives).</li><li>Information about the company's **related companies** (legal entity representatives, if applicable).</li><li>**Required documents** to verify your organization. You might not see this step in your onboarding process.</li><li>User [**signs up**](../../users/index.mdx#signup) for Swan.</li></ol>You can also customize this form to better meet your needs. Review the [Swan Partner Frontend](https://swan-io.github.io/swan-partner-frontend/specs/onboarding/company/) repository for customization options, then contact your Swan representative for more information. |
