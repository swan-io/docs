...
An account can have multiple account members. 
An account membership grants a user access to and specific rights within an account.
If an account holder has more than one account, the legal representative manages account memberships.

### Legal representative membership

When an account holder creates additional accounts, the legal representative of their account is automatically added as a member of each new account. 
...
This means other account members need an invitation for each additional account.
