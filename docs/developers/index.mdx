...
With Swan's GraphQL API, you can request data and perform actions on your accounts, cards, transactions, and more.
...
## Advantages of GraphQL {#advantages}
...
## GraphQL building blocks {#graphql-blocks}
...
Consider a [query example from onboarding](../topics/onboarding/overview/guide-get-info.mdx#query) to see more complexity, including nested fields.
