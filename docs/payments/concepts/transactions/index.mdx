...
related:
  ...
  - /payments/guides/overview/get-transaction-info
...
You can [generate transaction statements](/payments/guides/overview/generate-transaction-statement) for eligible `Booked` transactions with the API.
...
Add the `statementCanBeGenerated` boolean, as shown in the [guide to get transaction information](/payments/guides/overview/get-transaction-info).
:::
