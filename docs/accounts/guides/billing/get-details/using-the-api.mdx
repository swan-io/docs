...
audience:
  - dev
counterpart: /accounts/guides/billing/get-details/from-the-dashboard
related:
  - /accounts/guides/billing/get-details
  - /accounts/guides/billing/get-details/from-the-dashboard
  - /accounts/concepts/billing
---

# Get invoice details using the API
