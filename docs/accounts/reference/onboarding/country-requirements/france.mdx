...
| Formulaire Personne Politiquement Exposée (PPE) | <Term id="pep">Politically Exposed Person</Term> (PEP) form | <ul><li>Will be sent to the end user (based on your communication preferences).</li><li>Must be dated and signed.</li></ul> |
