...
If you embed Swan into your own mobile app, integrate Strong Customer Authentication (SCA) using an **in-app browser** so your users complete SCA without leaving your app.
