...
After accepting the invitation, the new administrator is automatically directed to Swan's [identity verification flow](/topics/users/identifications/). No manual link sharing is needed.
...
- **No prior identification:** Swan guides the new administrator through the appropriate [identification](/topics/users/identifications/) process automatically after they accept the invitation.
