...
- Updating an account membership requires consent from the account member.
- You must use a [user access token](../../../developers/using-api/authentication/index.mdx#tokens-user) for this mutation. Project access tokens are not supported.
