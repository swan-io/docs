...
Because errors aren't [strongly typed](../index.mdx#graphql-types) like the rest of the GraphQL schema, there's **no guaranteed format or structure** to error responses.
...
In the Swan [schema](../index.mdx#graphql-schema), a `Rejection` is an object containing a descriptive message.
