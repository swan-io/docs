...
👮 Starting **February 5**, new rejections apply to the [`openAccount`](https://api-reference.swan.io/mutations/open-account/) mutation to prevent fraud patterns involving successive opening and closing of [multiple accounts](/accounts/concepts/multiple-accounts) to bypass the [account creation limit](/accounts/reference/accounts/multiple-accounts-requirements#account-creation-limit):
...
🚫 Starting **February 26**, the following rules apply to [limited accounts](/accounts/concepts/account/type-and-level):
