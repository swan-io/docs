...
Start exploring the Sandbox, rapidfire mode. 🔥

:::note Steps 1-3
The first three steps might feel familiar; they're the same in the [step-by-step guide](./step-by-step.mdx).
:::
...
1. Submit [supporting documents](../onboarding/documents/index.mdx) if required.
