...
mutation AddCriticalEventsSubscription {
  addWebhookSubscription(
    input: {
      url: "https://api.yourcompany.com/webhooks/critical"
      ...
      subscriptions: [
        ...
        {
          eventType: AccountMembership.Suspended
        }
        {
          eventType: Account.Closing
        }
      ]
    }
  ) {
    ... on AddWebhookSubscriptionSuccessPayload {
      __typename
      webhookSubscription {
        id
        url
  ...
  addWebhookSubscription(
    input: {
      ...
      subscriptions: [
        ...
        {
          eventType: MerchantPayment.Captured
        }
      ]
    }
  ) {
...
mutation AddAdminEventsSubscription {
  addWebhookSubscription(
    input: {
      url: "https://api.yourcompany.com/webhooks/admin"
      secret: "$YOUR_WEBHOOK_SECRET_ADMIN"
      subscriptions: [
        {
          eventType: AccountInvoice.Generated
        }
        {
          eventType: AccountStatement.Generated
        }
        {
          eventType: SupportingDocumentCollection.Updated
        }
      ]
    }
  ) {
