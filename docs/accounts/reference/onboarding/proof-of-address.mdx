...
Swan users are sometimes asked for **provide proof of their residence address** as part of the [**account onboarding**](/accounts/guides/onboarding) process.
Additionally, [**capital deposit shareholders**](/accounts/guides/onboarding/capital-deposits/#shareholders) must provide proof of address to comply with financial regulations.
