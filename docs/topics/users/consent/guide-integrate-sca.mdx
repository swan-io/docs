...
| --- | --- |
| Any | [React Native Browser](https://github.com/swan-io/react-native-browser) by Swan open source<br /><br /><ul><li>[Android implementation example](https://github.com/swan-io/react-native-browser/blob/main/android/src/main/java/io/swan/rnbrowser/RNSwanBrowserModuleImpl.java)</li><li>[iOS implementation example](https://github.com/swan-io/react-native-browser/blob/main/ios/RNSwanBrowser.mm)</li></ul> |
...
:::info Using Swan's React Native Browser module
If you choose Swan's React Native Browser module, it also takes care of listening to the event.<br />
Make sure to remove the following line of code from your app in steps 3.1, 3.5, and 4.3.
...
:::warning Skip if using React Native Browser module
Swan's React Native Browser module takes care of listening to the event.<br />
If you chose Swan's module in step 1, you can skip step 2.
:::
