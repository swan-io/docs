...
1. **[SEPA Creditor Identifier (SCI)](/payments/concepts/merchants/sepa-direct-debit#sci)**: Each creditor is identified on the SEPA network with their unique identifier.
