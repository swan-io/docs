...
The `beneficiaryVerification` query will be deprecated. Plan [your migration](/topics/payments/credit-transfers/sepa/vop/verification-of-payee) before the compliance deadline to ensure uninterrupted service.
:::
