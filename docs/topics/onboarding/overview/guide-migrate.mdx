...
After the previous mutations are removed at the end of September 2026, all in-progress onboardings using the previous API must already be finalized.
...
| September 2026 | Previous mutations and queries removed. |
