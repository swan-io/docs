...
Swan sends email notifications to users during the onboarding process. These notifications support your partner project branding, including your logo and accent colors.
