...
You can direct users to upload documents through Swan's Web Banking interface.

Use the `supportingDocumentCollectionUrl` field from the supporting document collection (retrieved in step 4) to get the URL to the upload form.

Share this URL with your users so they can upload their documents directly in Web Banking.
