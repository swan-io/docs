...
Edges are _edge types_, and are GraphQL objects.
...
- `first`: takes a non-negative integer `n` and loads only the _first_ `n` elements from your list (maximum: 100)
- `before`: loads all elements occurring _before_ the provided index
