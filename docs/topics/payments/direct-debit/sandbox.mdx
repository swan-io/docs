...
When testing your integration, you might need to simulate certain events with the [Testing API](/dev-tools/tools/testing-api) and the [Event Simulator](/dev-tools/tools/event-simulator).
