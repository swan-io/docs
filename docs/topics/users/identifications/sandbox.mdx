...
You can only [impersonate](/developers/using-api/authentication/guide-impersonate/) [Sandbox users](../../tools/sandbox-users.mdx#add) who are linked to your project.
:::
