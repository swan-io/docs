  ...
  <div className="col col--6">
    <div className="card" style={{height: '100%', backgroundColor: '#fffbf0', border: '1px solid #ffeaa7'}}>
      ...
      <div className="card__body">
        <p><strong>Swan automatically verifies beneficiary details when you initiate a credit transfer</strong></p>
        <ul>
...
For company accounts that want to enable VoP verification on bulk SEPA Credit Transfers.
