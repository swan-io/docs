...
Add **<Term id="trusted-beneficiary">trusted beneficiaries</Term>** to accounts to facilitate credit transfers.
...
- Optional field where you can name your <Term id="transactions">transaction</Term>.
