...
| `Canceled` | The case was canceled before completion by either you or Swan. A [cancelation reason code](#cancelation-reason-codes) is available on the `CapitalDepositCaseCanceledStatusInfo` type. |
