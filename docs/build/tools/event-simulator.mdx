...
![Image of Dashboard Event Simulator page](../../images/build/tools/event-simulator.png)
...
If there is an event you'd like to simulate to test your integration, please speak with your PIM (Product Integration Manager).
:::
...
![Image of Dashboard Event Simulator example using SEPA Credit Transfers](../../images/build/tools/simulator-example.png)
...
- [Testing the API](/build/tools/testing-api) · [Sandbox users](/build/tools/sandbox-users) · [Test tools guide](/build/tools/test-tools-guide)
