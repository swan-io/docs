...
1. Click **Simulate**.
1. After clicking **Simulate**, notice the status change to `Success`. A `CardOutDebit` transaction is created with the status `Booked`, without a linked `CardOutAuthorization`.
