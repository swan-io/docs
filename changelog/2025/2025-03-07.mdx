...
👥 Starting on **March 20**, account memberships are only returned in the `accountMemberships` and `account.Memberships` queries if you have the `canManageAccountMembership` [permission](/topics/accounts/memberships/#permissions).
