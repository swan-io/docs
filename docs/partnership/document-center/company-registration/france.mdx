...
| Déclaration des bénéficiaires effectifs et pièce d'identité des UBOs | UBO declaration and identity documents of UBOs | <ul><li>For example:<ul><li>Copie intégrale des informations déclarées</li><li>Déclaration Relative au(x) Bénéficiaire(s) Effectif(s) d'une Société</li><li>Document Relatif au Bénéficiaire Effectif</li></ul></li><li>Must be an official document, dated, signed, and stamped.</li><li>Provided by the account holder.</li></ul> |
| Justificatif de domicile des bénéficiaires effectifs | Proof of address of UBOs | <ul><li>Must be dated within the last 3 months.</li><li>Provided by the account holder.</li></ul> |
| Formulaire Personne Politiquement Exposée (PPE) | Politically Exposed Person (PEP) form | <ul><li>Will be sent to the end user (based on your communication preferences).</li><li>Must be signed and dated.</li></ul> |
