...
<ul>
    ...
    <li>Finnish isn't available for the [**bank details document**](/accounts/concepts/account#bank-details). When the account language is Finnish, the bank details document is generated in English.</li>
</ul>
:::
