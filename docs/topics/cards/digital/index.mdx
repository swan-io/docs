...
Both events are sent no matter how the card was added, including when a cardholder adds it to their wallet manually. This helps you keep your app in sync with the card's actual provisioning status.
