...
1. The person who performed the onboarding process becomes the legal representative of the account. They're also the account's first member with [full permissions](/accounts/reference/memberships/membership-permissions).
