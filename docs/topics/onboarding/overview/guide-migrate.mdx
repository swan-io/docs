...
After the previous mutations are removed at the end of September 2026, you can only update or finalize onboardings through the current API mutations, including any in-progress onboardings created under the previous API. Make sure your integration is fully migrated by then.
