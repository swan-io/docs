...
**Verification of Payee (VoP)** is a new European service that checks beneficiary details against account holder information before initiating SEPA Credit Transfers. This service aims to reduce payment fraud and errors by confirming that the beneficiary details match the account holder registered with the beneficiary's bank.
...
<div className="row margin-bottom--lg">
  ...
  <div className="col col--6">
    <div className="card" style={{height: '100%', backgroundColor: '#f0f9f0', border: '1px solid #d4edda'}}>
      <div className="card__header">
        <h3>Option 2:</h3>
        <h3>☑️ Custom verification</h3>
      </div>
      <div className="card__body">
        <p><strong>Pre-validation of details: Verify beneficiaries before payment initiation</strong></p>
        <ul>
...
| Payment Type | Option 1: Default | Option 2: Custom | Notes |
| --- | --- | --- | --- |
...
```mermaid
flowchart TD
    subgraph Option2 ["🟢 Option 2: Custom"]
        direction TB
    ...
    subgraph Option1 ["🟡 Option 1: Default"]
        direction TB
...
:::warning 
**Option 1 is not available for Bulk Credit Transfers**. For bulk credit transfers, use Option 2 or if you have company customers, opt-out of VoP via the dedicated mutation.
:::
...
VoP integration with Swan's trusted beneficiary system and Internal Credit Transfers.
