...
<p className="ia-lede">Query funding sources, list an account's sources, and retrieve a funding transaction's release date with the API.</p>
...
- [Add a funding source](/accounts/guides/funding/add-source) · [Initiate a funding request](/accounts/guides/funding/initiate-request) · [Cancel a funding source](/accounts/guides/funding/cancel-source)
