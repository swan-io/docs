...
Field-level requirements and validation rules for account membership data. Use this alongside the [membership permissions reference](/accounts/reference/membership-permissions); for the model and lifecycle, see [Account memberships](/accounts/concepts/memberships).
...
- [Membership permissions](/accounts/reference/membership-permissions) — permissions matrix and card-management rules.
- [Account memberships](/accounts/concepts/memberships) — model, statuses, and language.
