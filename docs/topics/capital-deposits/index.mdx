...
<details>
  ...
  <div>
    <p>If a future company provides a lease agreement as proof of the official company address, other elements might also be required based on their situation.
