...
When you create a card product, you select a card package: **Standard**, **Essential**, or **Premium**. 
Each package includes a pre-built set of features and settings tailored to specific spending needs. 
