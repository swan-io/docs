...
|---|---|
| `NotStarted` | The identification request was created but the user hasn't begun yet. |
| `Started` | The user began the identification process, but they haven't completed it. Their identification is still in progress. |
...
| `Canceled` | An identification request is canceled by you, your user, or Swan. Identifications can be canceled from any non-final status. |
