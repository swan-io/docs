...
✍️ The `requestMerchantPaymentMethods` mutation now validates your [SEPA Creditor Identifier (SCI)](/payments/guides/merchants/online/sdd/#sci) when you request [SEPA Direct Debit](/payments/guides/merchants/online/sdd/request/).
