...
Your users can create merchant profiles during onboarding, but only if you've requested the feature for the account.
...
| --- | :---: | --- |
| **Business details** | <Req /> | The merchant's name and product type (`Goods`, `Services`, `VirtualGoods`, or `GiftAndDonations`). |
...
| **Business activity description** | <Opt /> | **Recommended**. A description of the products or services offered by the merchant. |
