...
🤖 Swan's new [MCP (Model Context Protocol) servers](/build/tools/mcp-servers) give AI assistants direct access to Swan's GraphQL schema and documentation. Use them with Claude Desktop, Claude Code, or Cursor to generate accurate queries and get answers about the API.
