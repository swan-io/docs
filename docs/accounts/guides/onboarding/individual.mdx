...
For a complete list of fields, country-specific requirements, and conditional rules, refer to the [individual onboarding field reference](/accounts/reference/individual-onboarding-fields).
...
Individual onboarding collects different fields per country (account and account administrator), with required/optional/conditional rules and API mapping tables. Those reference tables now live in [Individual onboarding fields](/accounts/reference/individual-onboarding-fields).
