...
→ Follow the [detailed guide](./guide-create-case-v2.mdx) to create your case with the `createCapitalDeposit` mutation, which includes a full API mutation example.
