...
- **Partner**: The notification uses Swan branding and includes data to help with your KYC process: Account Holder ID, Account Holder name, account IBAN, account BIC, account admin email, and account admin language.
...
**Template**: When the communication configuration is:
- **End customer**: The notification uses your project logo and accent color.
- **Partner**: The notification uses Swan branding and includes data to help with your KYC process: Account Holder ID, Account Holder name, account admin email, and account admin language.
- **Both parties**: The notification uses your project logo and accent color.

The email includes the account number to help users contact your support team.
...
The email includes the account's IBAN and BIC so users can start using their account.
