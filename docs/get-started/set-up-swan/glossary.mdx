...
Several Swan features may require payment mandates, including [account funding](/accounts/concepts/funding/payment-mandates), [accepting payments](/payments/guides/merchants/online/sdd/#mandates), and [received payment mandates for SEPA Direct Debit](/payments/concepts/direct-debit/#mandates).
