...
| Vereniging<br /><br />Stichting | KVK Extract | ✓ **Required**<br />if requested by Swan | ✓ **Required** | <ul><li>Meeting minutes, house rules (Huishoudelijk Reglement), member list, voting records, or board member documents, *and*</li><li>Tax documents, *and*</li><li>At least one of the following:<ul><li>Legal representative's identity document</li><li>UBO's proof of address</li></ul></li></ul> |
| Vereniging van Eigenaars (VvE) | KVK Extract | ✓ **Required**<br />if requested by Swan | *Not applicable* | <ul><li>Meeting minutes, house rules (Huishoudelijk Reglement), member list, voting records, or board member documents, *and*</li><li>Tax documents</li></ul> |
