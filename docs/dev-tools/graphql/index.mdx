...
Note that this is a basic example.
Consider the example of [requesting a merchant payment method](/topics/merchants/online/sdd/guide-request) to see more complexity.
...
- [Developer tools](/dev-tools) · [Authentication](/dev-tools/using-api/authentication)
