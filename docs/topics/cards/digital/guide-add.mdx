...
Contact your Swan Technical contact or submit a ticket through your Dashboard before integrating `activateDigitalCard` into your app. This mutation requires Apple Pay and/or Google Pay certification.
:::
...
- **In-app provisioning**: Using your app requires a certification process. Contact your Swan Technical contact or submit a ticket through your Dashboard to get started.
