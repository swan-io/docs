...
| <Term id="standing-order">Standing Orders</Term> | Scheduled, recurring transfers within SEPA that can be instant or regular | None |
...
After credit transfers are initiated, other transactions, such as <Term id="r-transaction">R-transactions</Term>, can be linked to the credit transfer transaction.
