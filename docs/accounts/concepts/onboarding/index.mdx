...
<table>
  ...
  <tr>
    ...
    <td>Partner requests a collection review<br /><br />💡 You need to request a supporting document collection review after all supporting documents are uploaded. [Request a review](/accounts/guides/documents/request-collection-review) with the API or from your Dashboard.</td>
    <td><center>`Pending`</center></td>
    <td><center>`PendingReview`</center></td>
  </tr>
  <tr>
