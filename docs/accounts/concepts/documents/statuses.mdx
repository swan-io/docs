...
The lifecycle below is described for onboarding-related collections; collections requested for [transactions or verification renewal](/accounts/concepts/documents#required-documents) move through the same statuses.
