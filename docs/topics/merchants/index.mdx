...
| **Projected volumes** | <Req /> | Include the expected monthly payment volume and average order value. Helps assess business size and risk. |
| **Link to the merchant's website or social network** | <Opt /> | **Highly recommended**. This helps us understand the merchant's business.  |
| **Description of the business activity** | <Opt /> | **Highly recommended**. A clear explanation of what the merchant offers or sells. |
