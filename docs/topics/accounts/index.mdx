...
Each month, Swan **generates account statements** automatically for **all Swan accounts** using the Central European [Summer] Time (CET/CEST) timezone.
...
:::caution 5 - Swan partnership disclaimer
