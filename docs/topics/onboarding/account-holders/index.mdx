...
Learn more about [requesting a first transfer](./guide-request-first-transfer.mdx) and [account limitations and capabilities](../../accounts/index.mdx#account-type-level).
...
**Configuration**: Swan can set up this notification for you based on your communication preferences. The available options include sending notifications directly to your customer, to you as the partner, copying both parties, or using the API to manage communications yourself. You can view the current configuration in your **Dashboard** under **Settings** > **Notifications**; however, it cannot be edited there. To make any updates, please reach out to us.
...
**Configuration**: Swan can configure this notification on your behalf. Contact your Account Manager to discuss your preferences. The available communication options are the same as for the first transfer notification. You can view its configuration in your **Dashboard** under **Settings** > **Notifications**, but it can't be edited there. To update it, contact Swan.
...
**Configuration**: Reminders are only sent when your document collection settings are configured to communicate with the end user (either directly or copied to you as the Partner). No reminders are sent when communications are Partner-only or managed via API. You can view its configuration in your **Dashboard** under **Settings** > **Notifications**, but it can't be edited there. To update it, contact Swan.
...
Make sure your [branding settings](/topics/projects/guide-activate/#step-8-configure-your-branding-in-live) (logo and accent color) are up to date in your **Dashboard** > **Settings** > **Branding**.

#### Verification renewal steps {#verification-renewal-portal-steps}

The legal representative (account admin):

1. Receives the [initial notification email](/topics/onboarding/account-holders/#verification-renewal-timeline) with a unique portal link.
...
We send the initial form and all follow-ups based on your [communication preferences](/topics/onboarding/account-holders/#notifications). 
