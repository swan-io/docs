...
1. Please use our Partner Support Request form available on your Dashboard, stating that you'd like to begin the custom design process. Include how many cards you'll print in the first batch (1000 minimum).
...
1. Send your design to your PIM (Product Integration Manager).
1. Your PIM will work with Mastercard to validate your design.
...
You need Swan's approval before you can customize your card or packages. To request it, contact your Strategic Account Manager (SAM).
:::
...
You can also request custom colors outside this list. Please use the Partner Support Request form available on your Dashboard to discuss options.
