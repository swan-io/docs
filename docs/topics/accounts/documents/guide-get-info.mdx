...
Use the Dashboard to review information about an transaction document.

1. Go to **Data** > **Accounts**.
1. Open an account, then go to **Supporting documents**.
1. Review all available information about your documents. 

![Get a document ID from the Dashboard](../../../images/topics/accounts/documents-get-info-transactions.png)
...
![Get a document ID from the Dashboard](../../../images/topics/accounts/documents-get-info-onboarding.png)