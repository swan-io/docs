...
:::info Requirements
Bulk credit transfers require [Option 2: Custom verification](#option-2) using [the `verifyBeneficiary` mutation](/preview/vop/guide-verify-beneficiary). The default verification flow doesn't support bulk payments.
:::
