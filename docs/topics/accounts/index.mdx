...
| `Limited` + `PaymentService` | <Yes /> The account's main IBAN is displayed.<br /><Yes /> Money can be added to the account.<br /><br /><No /> Account holder verification isn't complete.<br /><No /> Payments can't be made from the account. |
