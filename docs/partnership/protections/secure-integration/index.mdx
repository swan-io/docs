...
Swan imposes [rate limits](/developers/#rate-limits) on its API, but you must also protect your own endpoints and integration flows.
...
Swan offers a Sandbox environment, as described in [Environments](/developers/#environments), to support the separation of pre-production and Live environments.
