...
The `beneficiaryVerification` query will be deprecated on October 31, 2025. Migrate to the new [Verification of Payee (VoP)](/topics/payments/credit-transfers/sepa/vop/verification-of-payee) instead before the compliance deadline.
:::
