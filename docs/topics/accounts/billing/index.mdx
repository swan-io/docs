...
| | Additional account fee | A monthly fee is charged to the account holder for opening the initial account, which covers the opening of any additional accounts associated with it.|
...
| | Card subscriptions | Virtual cards `Enabled` at least one day during the billing period. The subscription fee is waived if you create and cancel the virtual card within the 24-hour period. |
