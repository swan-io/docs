...
This also means that each shareholder must go through the [onboarding](../onboarding/index.mdx), [identification](../users/identifications/index.mdx), and [verification](../onboarding/account-holders/index.mdx#verification-process) processes.
