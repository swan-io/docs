...
1. In the [API Explorer](https://explorer.swan.io/), add the `onboardCompanyAccountHolder` mutation.
1. Enter information for all required API fields for the account country, as noted in [country requirements for company accounts](./about.mdx#country-requirements).
