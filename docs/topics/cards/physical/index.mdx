...
:::info 
You can't choose a custom PIN for a cardholder who hasn't [completed identification](../../users/identifications/index.mdx) or whose [account membership status](/accounts/concepts/memberships/statuses#binding-errors) is `BindingUserError`.
:::
