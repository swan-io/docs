...
→ [Initiate SEPA Credit Transfers](/topics/payments/credit-transfers/sepa/guide-initiate-ct)

→ [Initiate International Credit Transfers](/topics/payments/credit-transfers/international/guide-initiate)
...
- [Supporting documents](/accounts/concepts/documents) — how transaction collections and documents are modeled.
- [Get document information](/accounts/guides/documents/get-info) — retrieve transaction collection and document details.
- [Upload onboarding documents](/accounts/guides/documents/upload-onboarding) · [Delete a document](/accounts/guides/documents/delete)
