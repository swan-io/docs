...
Merchants are account holders who want to accept payments by card, SEPA Direct Debit, Internal Direct Debit, in-person cards, or French checks, either directly from a payment link or an invoice. 
