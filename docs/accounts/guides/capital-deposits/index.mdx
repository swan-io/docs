...
- [Create a case](/accounts/guides/capital-deposits/create-case)
- [Upload documents](/accounts/guides/capital-deposits/upload-documents)
- [Cancel a case](/accounts/guides/capital-deposits/cancel)
- [Update company](/accounts/guides/capital-deposits/update-company)
- [Update shareholder amount](/accounts/guides/capital-deposits/update-shareholder-amount)
...
Learn more about the stakeholders and their interactions to complete a capital deposit on this page before continuing to the [guide for 🇫🇷 France](/accounts/guides/capital-deposits/#france).
...
A capital deposit case moves through several statuses. See [Capital deposit case statuses](/accounts/reference/capital-deposits#case-statuses).

### Cancelation reason codes {#cancelation-reason-codes-leadin}

When a case is canceled, a reason code explains why. See [Cancelation reason codes](/accounts/reference/capital-deposits#cancelation-reason-codes).
...
Several documents are required from shareholders and the future company. See [List of required documents](/accounts/reference/capital-deposits#documents-list).

### Document statuses {#documents-statuses-leadin}

Each document moves through statuses as Swan reviews it. See [Document statuses](/accounts/reference/capital-deposits#documents-statuses).
...
Refer to the **list of acceptable documents** in the [Partnership Document Center](/accounts/reference/onboarding/proof-of-address).

### Shareholder statuses {#shareholders-statuses-leadin}

Each shareholder moves through several statuses as they onboard and transfer funds. See [Shareholder statuses](/accounts/reference/capital-deposits#shareholders-statuses).
...
- Updates the [case status](/accounts/reference/capital-deposits#case-statuses) to `WaitingForShareDepositCertificate` so it gets sent to the notary.
