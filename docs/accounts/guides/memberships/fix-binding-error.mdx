...
- `emailVerifiedMatchError`: User needs to verify their email address through the [authorization URL](/accounts/concepts/memberships#invite).
- `idVerifiedMatchError`: User needs to complete the appropriate [identification process](/topics/users/identifications/).
...
- [Account memberships](/accounts/concepts/memberships#binding-errors) — what binding errors are and why they happen.
- [Update member](/accounts/guides/memberships/update) — the underlying mutation used to fix errors.
- [Resend invitation](/accounts/guides/memberships/resend-invitation) — resend if the invitee never accepted.
