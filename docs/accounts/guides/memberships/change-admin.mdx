...
Review the [account administrator change concept](/accounts/concepts/memberships/admin-change) for the full model, including the [reasons and required documents](/accounts/concepts/memberships/admin-change#documents), the [request statuses](/accounts/concepts/memberships/admin-change#statuses), and the [API surface](/accounts/concepts/memberships/admin-change#api).
