...
In-person merchant card payments include **one or more transactions**.
...
- [Accept in-person card payments](./accept.mdx)
- [Set up the development environment](./setup.mdx)
- [Request in-person card payment method](./request-method.mdx)
- [Initialize the device for payments](./initialize.mdx)
- [Create in-person card payments](./create-payments.mdx)
- [Sandbox](/payments/reference/sandbox/sandbox-merchant-in-person-cards)