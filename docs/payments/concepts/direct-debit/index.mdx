...
<p className="ia-lede">A creditor pulls funds from a debtor's account, by mandate. Swan supports <Term id="sdd">SEPA Direct Debit</Term> (Core and B2B) and Swan <Term id="direct-debit">Internal Direct Debit</Term>, in both directions.</p>
