...
### Allowed and blocked countries for card payments
...
<Tabs>
  <TabItem value="allowed" label={<><Yes /> Allowed</>} default>
    ...
    Users can make card payments in the following countries. Transactions will be processed unless rejected for other reasons, such as insufficient funds or card restrictions.
