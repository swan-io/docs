...
The [Single Euro Payments Area (SEPA)](https://www.europeanpaymentscouncil.eu/about-sepa) is a payment network used to **transfer funds in euros in 38 countries**.
...
* **Non-EU members**: Albania, Andorra, Iceland, Liechtenstein, Monaco, Montenegro, Norway, San Marino, Switzerland, United Kingdom (including Gibraltar), and Vatican City State/Holy See.
