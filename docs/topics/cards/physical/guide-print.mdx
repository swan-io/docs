...
If you use **Swan's Web Banking interface**, your users can [order their own cards](https://support.swan.io/hc/en-150/articles/17791219525149-Order-your-physical-card) if they have the correct [account membership permissions](/accounts/reference/membership-permissions#permissions-cards).
...
:::tip Prerequisites
1. Confirm the account member has the [correct account membership permissions**](/accounts/reference/membership-permissions#permissions-cards) to manage cards and, if needed, account memberships.
...
:::tip Prerequisites
Confirm the account member printing the cards has the [**correct account membership permissions**](/accounts/reference/membership-permissions#permissions-cards) to manage cards **and** account memberships.
:::
