...
The maximum cumulative balance allowed on a limited account is €150.
Any incoming SEPA Credit Transfer, regardless of its amount, that would cause the balance to exceed €150 is automatically rejected.
