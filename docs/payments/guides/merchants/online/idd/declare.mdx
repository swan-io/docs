...
[Review the requirements](/payments/concepts/merchants/internal-direct-debit#mandates) for Internal Direct Debit payment mandates if needed.
...
1. Choose either Standard or B2B in your [mandate name](/payments/concepts/merchants/internal-direct-debit#mandates-info) (line 6).
1. Choose `Recurrent` or `OneOff`.
    - [`OneOff` payment mandates](/payments/concepts/merchants/internal-direct-debit#mandates-oneoff) can only be used once.
