...
| Documento d'identità del titolare effettivo* | Identity documents of Ultimate Beneficial Owners (UBOs)* | <ul><li>All valid identity (ID) documents are accepted.</li><li>If the ID doesn't include an Italian tax ID number, Swan requests the Italian national health card (*Tessera Sanitaria*).</li><li>Must be submitted in color, both sides (if applicable).</li></ul> |
...
| Modulo per le persone politicamente esposte | Politically Exposed Person (PEP) form | <ul><li>Swan sends this form to the end user (based on your communication preferences).</li><li>Must be dated and signed.</li></ul> |
...
| Documento d'identità dell'azionario effettivo | ID documents of UBOs | <ul><li>All valid ID documents (including passports) are accepted.</li><li>If the end user doesn't provide the new ID (which includes the tax ID), Swan requests the Italian national health card (*Tessera Sanitaria*) to retrieve the tax ID.</li></ul> |
