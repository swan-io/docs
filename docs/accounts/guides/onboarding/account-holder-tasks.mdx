...
1. Swan provides users with their Swan <Term id="ibans">IBAN</Term> and BIC via email. We also inform users about account restrictions: transfers must be €50 or less, and the balance cannot exceed €150.
