...
| Visura camerale / Iscrizione al RUNTS\* | Proof of registration\* | • [⚠️ confirm with KYC: retrieved by Swan or provided by the account holder?] |
| Justificativo dell'indirizzo della sede legale | Proof of company address | • Must be dated within the last 3 months.<br />• [⚠️ confirm Italian doc name with KYC] |
| Procura e documento d'identità del rappresentante legale | Power of Attorney and identity document of the legal representative | • Must be dated within the last year and signed.<br />• Identity document required if the legal representative isn't the account holder.<br />• Provided by the account holder. |
| Struttura organizzativa / Organigramma | Governance structure documentation | • Required when the association's governance structure is complex or not clear from other documents.<br />• Provided by the account holder. |
| Formulario Persona Politicamente Esposta (PEP) | Politically Exposed Person (PEP) form | • Sent to the user (based on your communication preferences).<br />• Must be dated and signed. |
