...
<Tabs>
  <TabItem value="local-currencies" label="🌍 Local" default>
  ...
  <TabItem value="swift-usd" label="🇺🇸 USD/SWIFT">
  ...
  <TabItem value="incoming" label="📥 Incoming">
...
:::note ICT fees for same-country transfers
Users will see a €5 fee if they receive euros from the same country and the sending bank uses SWIFT instead of SEPA.  For example, this can happen with a treasury transfer (virement de trésorerie) between French accounts. Share this [Swan Support Center article](https://support.swan.io/hc/en-150/articles/20983746712861-Currency-exchange-and-fees-for-International-Credit-Transfers) with your users to help them understand these fees.
:::
...
- The transfer exceeds the [maximum transaction amount limit](/topics/payments/credit-transfers/international/#transfer-limits). 
...
Learn more about [limited accounts and verification](../../../onboarding/account-holders/index.mdx#limited-account-restrictions).
