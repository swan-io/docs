...
<p className="ia-lede">Account onboarding is the process that creates <Term id="account-holder">account holders</Term> and opens their first Swan account. This is the model behind it: the types, the purpose, and the statuses, notifications, and renewals that span every onboarding.</p>
