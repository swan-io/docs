...
1. **Swan sends email notifications** about account closure. Please review the section on [email communications](/accounts/concepts/closure/communications) for precise details.
