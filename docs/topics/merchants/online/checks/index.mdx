...
| `availableToCancel` | Use this balance to verify whether the payment can be canceled. Cancellations must occur before the check is received by Swan's check provider. |
