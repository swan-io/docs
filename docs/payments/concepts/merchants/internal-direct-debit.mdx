...
Partners are responsible for handling <Term id="payment-mandates">payment mandates</Term>.
...
| Debtor information | Choose one of the following options:<ul><li>Debtor's account number</li><li>Debtor's <Term id="ibans">IBAN</Term></li></ul><br/>If the debtor doesn't have a Swan account upon creation of the mandate, include their identification information instead:<ul><li>Individual: given name, family name, and date of birth</li><li>Legal: name and SIREN</li></ul> |
