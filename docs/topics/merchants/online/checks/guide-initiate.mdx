...
1. Add the `fnciInfo` to the success payload (lines ). Refer to the explanatory content to [learn about FNCI and their verification results](./index.mdx#fnci) (lines 12-18).
...
```graphql {2-7,10,12-18,21,24-30} showLineNumbers
