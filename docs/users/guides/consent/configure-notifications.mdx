...
For when to use consent notifications and how they work, refer to [notification preferences](/users/concepts/consent#notifications).
...
:::tip Prerequisites
Authenticate with a [project access token](/build/using-api/authentication#tokens-project).
:::
...
<a href="https://explorer.swan.io?query=%3D%3D&tab=api" className="explorer-badge">Open in API Explorer</a>
