...
![Image of Dashboard calling out where to download Swan's Postman collection](../../images/build/tools/implementation-download-sp.png)

## Step 2: Import Swan collection to Postman

In Postman, click **Import**, then import the file you downloaded from your Dashboard.

![Image of Dashboard calling out where to download Swan's Postman collection](../../images/build/tools/implementation-import.png)
...
![Image of Dashboard calling out where to find the information required for Postman](../../images/build/tools/implementation-get-info.png)
...
![Image of Postman calling out where to enter your Swan values](../../images/build/tools/implementation-configure.png)
...
![Image of Postman guiding user to get a new project access token](../../images/build/tools/implementation-token-project.png)
...
![Image of Postman guiding user to use the new project access token](../../images/build/tools/implementation-token-project-use.png)
...
![Image of Postman guiding user to get a new user access token](../../images/build/tools/implementation-token-user.png)
...
![Image of Postman guiding user to use the new user access token](../../images/build/tools/implementation-token-user-use.png)
