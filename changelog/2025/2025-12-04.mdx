...
📩 Starting **December 18**, account membership invitations migrate to the new branded notification template. If you use a forked version of Web Banking, fetch and deploy the latest version from Swan's repository to continue receiving Swan-sent invitation emails.