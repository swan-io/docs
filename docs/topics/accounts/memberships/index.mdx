...
<table>
  ...
  <tr>
    <td>`Cards` = true</td>
    <td>
      ✓ View, add, and update cards for self
      <br />✓ View, add, and update cards for others∗
    </td>
    <td>
      ✓ View, add, and update cards for self
      <br />☒ Can't view, add, or update cards for others
    </td>
  </tr>
  <tr>
    <td>`Cards` = false</td>
    <td colspan="2">
      ...
      <br />☒ Can't add virtual cards for self
      <br />✓ If they have an existing virtual card, they can print a physical
      card for self
      <br />☒ Can't update any cards for self
      <br />☒ Can't view, add, or update cards for others
    </td>
  </tr>
  <tr>
...
∗ _others_ → other account members
