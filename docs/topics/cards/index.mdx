...
Learn more about [consent with Swan](https://docs.swan.io/api/consent#consent-on-mobile).

| Action | Mutations |
|---|---|
| Adding cards | <ul><li>`addCard`</li><li>`addCards`</li><li>`addCardsWithGroupDelivery`</li><li>`addDigitalCard`</li><li>`addSingleUseVirtualCard`</li><li>`addSingleUseVirtualCards`</li></ul> |
| Printing, activating, and updating cards | <ul><li>`printPhysicalCard`</li><li>`activatePhysicalCard`</li><li>`resumePhysicalCard`</li><li>`updateCard`</li></ul> |
| Viewing sensitive information | <ul><li>`viewCardNumbers`</li><li>`viewPhysicalCardPin`</li></ul> |
...
Learn more about designing your card products in the [card design](./design/index.mdx) section.
...
![Screenshot of the Dashboard cards page with callouts on an existing card and create new](../../images/topics/cards/cards-dashboard-settings.png)
...
![Image displaying connection between account holders, account, account membership, and cards](../../images/topics/cards/cards-flow-multiple.png)
...
![Image displaying connection between account holders, account, account membership, and cards](../../images/topics/cards/cards-flow-single.png)
...
Refer to the corresponding sections for [virtual](./virtual/index.mdx#virtual-card-statuses), [physical](./physical/index.mdx#physical-card-statuses), and [digital](./digital/index.mdx#digital-card-statuses) cards.
