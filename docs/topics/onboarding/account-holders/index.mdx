...
**Template**: When the communication configuration is:
- **End customer**: The notification uses your project logo and accent color.
- **Partner**: The notification uses Swan branding and includes data to ease your KYC operations: Account Holder ID, Account Holder name, account IBAN, account BIC, email of the account admin, and account admin language.
- **Both parties**: The notification uses your project logo and accent color.
...
**Template**: When the communication configuration is:
- **End customer**: The notification uses your project logo and accent color.
- **Partner**: The notification uses Swan branding and includes data to ease your KYC operations: Account Holder ID, Account Holder name, email of the account admin, and account admin language.
- **Both parties**: The notification uses your project logo and accent color.

The email includes the account's number to help users contact your customer service department if they have any questions.
...
The email includes the account's IBAN and BIC to notify users to start using their account.
