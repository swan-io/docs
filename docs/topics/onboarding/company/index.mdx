...
> **Self-employed** users hold company accounts. Refer to the country
> requirements section for more information about identification for
> self-employed users.
...
| `name` _(company name)_                    | ✓ Required           | ✓ Required           | ✓ Required           | ✓ Required           |
| `redirectUrl`                              |                      |                      |                      |                      |
| `registrationNumber`<br/>_(if registered)_ | ✓ Required           | ✓ Required           | ✓ Required           | ✓ Required           |
...
Otherwise, the account i suspended._
...
| `UBO.residencyAddress.country`      | ✓ Required    | ✓ Required     | ✓ Required         | ✓ Required   |
...
<details>
  <summary>
    End-user perspective of providing company onboarding documents
  </summary>
  <div>
    <iframe
