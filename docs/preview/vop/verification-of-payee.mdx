...
Swan provides comprehensive VoP support as both a requesting and responding Payment Service Provider:
...
[Learn about incoming VoP requests →](/preview/vop/incoming-vop-requests)
...
<div className="row margin-bottom--lg">
  ...
  <div className="col col--6">
    <div className="card" style={{height: '100%', backgroundColor: '#f0f9f0', border: '1px solid #d4edda'}}>
      ...
      <div className="card__body">
        <p><strong>Use [the `verifyBeneficiary` mutation](/preview/vop/guide-verify-beneficiary) for full control over verification presentation</strong></p>
        <ul>
...
| **Bulk Credit Transfers** | <Unsupported /> | <Supported /> | [See bulk transfers →](/preview/vop/bulk-credit-transfers) |
...
1. **Verify beneficiary**: Call [the `verifyBeneficiary` mutation](/preview/vop/guide-verify-beneficiary#step-1) - include the [beneficiary details](/preview/vop/guide-verify-beneficiary#step-1) to check against.
...
:::info Requirements
Bulk credit transfers require [Option 2: Custom verification](#option-2) using the [`verifyBeneficiary`](/preview/vop/guide-verify-beneficiary) mutation. The default verification flow doesn't support bulk payments.
:::
...
**Learn more**: [Configure bulk credit transfers with VoP →](/preview/vop/bulk-credit-transfers)
...
→ Understand how Swan handles [incoming VoP requests](/preview/vop/incoming-vop-requests) automatically