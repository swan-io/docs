...
Queries are highly customizable. This guide focuses solely on using the **`paymentMandate`** query to get the mandate URL. Learn more about this query in the guide to [get payment information](link_to_get_payment_information_guide).
